rule RAN_Matrix_Sep_2020_1  {
   ...
   strings:
      ...
      $reg1 = { 2e 00 70 00 68 00 70 00 3f 00 61 00 70 00 69 00 6b 00 65 00 79 00 3d }       $reg2 = { 26 00 63 00 6f 00 6d 00 70 00 75 00 73 00 65 00 72 00 3d }       $reg3 = { 26 00 73 00 69 00 64 00 3d 00 }       $reg4 = { 26 00 70 00 68 00 61 00 73 00 65 00 3d }       $reg5 = { 47 00 45 00 54 }    condition:
