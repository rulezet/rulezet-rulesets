rule APT_UNC2452_Webshell_Chopper_Mar_2021_1 {
   ...
   strings:
            ...
            $c1 = { 5c 4f 41 42 20 28 44 65 66 61 75 6c 74 20 57 65 62 20 53 69 74 65 29 }       $c2 = "ExternalUrl" fullword ascii       $c3 = { 49 49 53 3a 2f 2f [10-30] 2f 57 33 53 56 43 2f [1-3] 2f 52 4f 4f 54 2f 4f 41 42 }       $c4 = "FrontEnd\\HttpProxy\\OAB" fullword ascii
