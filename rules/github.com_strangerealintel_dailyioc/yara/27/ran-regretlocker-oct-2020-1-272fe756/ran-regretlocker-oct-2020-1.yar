rule Ran_RegretLocker_Oct_2020_1 {
   ...
   strings:
      ...
      $com2 = { 63 6d 64 2e 65 78 65 00 20 26 20 00 2f 43 20 70 69 6e 67 20 31 2e 31 2e 31 2e 31 20 2d 6e 20 31 20 2d 77 20 33 30 30 30 20 3e 20 4e 75 6c 20 26 20 44 65 6c 20 2f 66 20 2f 71 20 22 25 73 22 }       $com3 = "bcdedit.exe / set{ default } recoveryenabled No" fullword ascii
      ...
      $str1 = { 47 45 54 20 25 73 20 48 54 54 50 2f 31 2e 30 0d 0a 48 6f 73 74 3a 20 25 73 }       $str2 = { 50 4f 53 54 20 25 73 20 48 54 54 50 2f 31 2e 31 0d 0a 48 6f 73 74 3a 20 25 73 }       $str3 = "Content-Type: application/x-www-form-urlencoded" fullword ascii
   condition:
