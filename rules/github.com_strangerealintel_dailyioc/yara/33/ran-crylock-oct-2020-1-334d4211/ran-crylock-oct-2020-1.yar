rule RAN_CryLock_Oct_2020_1 {
   ...
   strings:
      ...
      $debug4 = { 49 45 28 41 4c 28 22 25 73 22 2c 34 29 2c 22 41 4c 28 5c 22 25 30 3a 73 5c 22 2c 33 29 22 2c 22 4a 4b 28 5c 22 25 31 3a 73 5c 22 2c 5c 22 25 30 3a 73 5c 22 29 22 29 }       $debug5 = { 4a 75 6d 70 49 44 28 22 22 2c 22 25 73 22 29 }       $debug6 = { 45 6e 63 72 79 70 74 65 64 20 62 79 20 42 6c 61 63 6b 52 61 62 62 69 74 2e 20 28 [3-10] 29 }              $ran1 = "w_to_decrypt.hta" wide
