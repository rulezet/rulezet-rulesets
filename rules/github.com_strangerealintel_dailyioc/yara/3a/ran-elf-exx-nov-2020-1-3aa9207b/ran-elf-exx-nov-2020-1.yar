rule Ran_ELF_EXX_Nov_2020_1 {
   ...
   strings:
      $dbg1 = { 55 6e 65 78 70 65 63 74 65 64 20 65 72 72 6f 72 2c 20 72 65 74 75 72 6e 20 63 6f 64 65 20 3d 20 25 30 38 58 0a }       $dbg2 = { 47 72 65 65 74 69 6e 67 73 20 [3-10] 21 }
      ...
      $dbg4 = { 53 48 41 2d 25 64 20 74 65 73 74 20 23 25 64 3a }       $lib1 = "pthread_mutex_unlock@@GLIBC_2.2.5" fullword ascii
