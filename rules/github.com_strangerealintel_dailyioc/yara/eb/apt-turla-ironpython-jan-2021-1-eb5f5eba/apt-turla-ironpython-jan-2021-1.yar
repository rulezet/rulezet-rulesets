rule APT_Turla_IronPython_Jan_2021_1 {
   ...
   strings:
      $lambda = { 3d 6c 61 6d 62 64 61 20 [1-6] 2c [1-6] 3a 27 27 2e 6a 6f 69 6e 28 5b 63 68 72 28 28 6f 72 64 28 [1-6] 29 5e [1-6] 29 25 30 78 [1-4] 29 20 66 6f 72 20 [1-6] 20 69 6e 20 [1-6] 5d 29 0a}       $lib1 = { 69 6d 70 6f 72 74 20 62 61 73 65 36 34 }       $lib2 = { 66 72 6f 6d 20 53 79 73 74 65 6d 2e 53 65 63 75 72 69 74 79 2e 43 72 79 70 74 6f 67 72 61 70 68 79 }       $lib3 = { 66 72 6f 6d 20 53 79 73 74 65 6d 2e 52 65 66 6c 65 63 74 69 6f 6e }       $shcode = /(\w.){6}.(', \d{1,3}\)){1}/ nocase       $cmd1 = "os.getenv" fullword ascii
