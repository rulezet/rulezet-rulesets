rule TrojanDownloader_Win32_Banload_AAS{
	...
	strings :
		$a_01_0 = {62 74 6e 69 6e 78 43 6c 69 63 6b } 		$a_01_1 = {62 74 6e 64 6f 78 43 6c 69 63 6b } 		$a_01_2 = {62 74 6e 73 65 78 43 6c 69 63 6b } 		$a_01_3 = {75 6e 69 74 63 72 69 70 74 } 	condition:
