rule TrojanClicker_Win32_Pulick_C{
	...
	strings :
		$a_01_0 = {77 69 6e 64 6f 77 2e 6f 6e 62 65 66 6f 72 65 75 6e 6c 6f 61 64 3d 6e 75 6c 6c 3b 77 69 6e 64 6f 77 2e 73 68 6f 77 4d 6f 64 61 6c 44 69 61 6c 6f 67 3d 6e 75 6c 6c 3b 77 69 6e 64 6f 77 2e 63 6f 6e 66 69 72 6d 3d 6e 75 6c 6c 3b 77 69 6e 64 6f 77 2e 6f 70 65 6e 3d 6e 75 6c 6c 3b 64 6f 63 75 6d 65 6e 74 2e 62 6f 64 79 2e 6f 6e 63 6c 69 63 6b 3d 6e 75 6c 6c 3b } 		$a_01_1 = {58 52 58 65 58 66 58 65 58 72 58 65 58 72 58 3a 58 } 		$a_01_2 = {6d 32 72 58 66 58 } 		$a_01_3 = {63 6c 69 63 6b 2e 68 74 6d 6c } 		$a_01_4 = {64 6f 75 62 6c 65 69 6d 70 } 		$a_01_5 = {6d 32 72 66 2e 63 6f 6d } 		$a_01_6 = {66 61 67 74 2e 63 6f 6d } 		$a_01_7 = {65 78 6f 63 6c 69 63 6b } 		$a_01_8 = {65 72 6f 2d 61 64 76 } 		$a_01_9 = {61 64 75 6c 74 61 64 77 6f 72 6c 64 } 	condition:
