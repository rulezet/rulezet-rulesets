rule TrojanDownloader_Win32_Tiny_GV{
	...
	strings :
		$a_01_0 = {53 45 43 20 44 6f 77 6e 6c 6f 61 64 65 72 } 		$a_00_1 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 } 		$a_00_2 = {2f 63 20 64 65 6c } 		$a_02_3 = {6a 00 6a 00 6a 04 6a 00 6a 00 6a 00 ?? ?? ?? ?? ?? 6a 00 ff 15 ?? 12 14 13 c7 05 ?? 15 14 13 07 00 01 00 68 ?? 15 14 13 ff 35 ?? 15 14 13 ff 15 ?? 12 14 13 a1 ?? ?? 14 13 a3 ?? 13 14 13 6a 00 68 ?? 01 00 00 68 ?? 11 14 13 ff 35 ?? 13 14 13 ff 35 ?? 15 14 13 ff 15 ?? 12 14 13 8b 35 ?? 13 14 13 ff 35 ?? 15 14 13 ff 15 ?? 12 14 13 ff 35 ?? 15 14 13 } 	condition:
