rule VirTool_Win32_Injector_gen_AF{
	...
	strings :
		$a_03_0 = {03 d1 03 c2 25 ff 00 00 80 79 ?? 48 0d 00 ff ff ff 40 } 		$a_01_1 = {35 9b 00 00 00 58 } 		$a_01_2 = {50 83 f0 0d 58 } 		$a_01_3 = {35 14 13 00 00 35 14 13 00 00 } 	condition:
