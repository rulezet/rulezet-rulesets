rule Backdoor_Win32_Matchaldru_D{
	...
	strings :
		$a_00_0 = {31 34 30 2e 31 31 32 2e 31 39 2e 31 39 35 } 		$a_01_1 = {73 65 61 72 63 68 35 25 64 } 		$a_01_2 = {26 68 34 3d } 		$a_00_3 = {4d 6f 7a 69 6c 6c 61 2f 35 } 		$a_00_4 = {b2 64 b1 25 } 	condition:
