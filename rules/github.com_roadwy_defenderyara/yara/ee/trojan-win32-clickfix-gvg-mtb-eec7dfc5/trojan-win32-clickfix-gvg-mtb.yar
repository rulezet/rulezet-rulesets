rule Trojan_Win32_ClickFix_GVG_MTB{
	...
	strings :
		$a_00_0 = {70 00 6f 00 77 00 65 00 72 00 73 00 68 00 65 00 6c 00 6c 00 } 		$a_00_1 = {69 00 65 00 78 00 28 00 69 00 72 00 6d 00 28 00 24 00 } 		$a_02_2 = {5b 00 73 00 74 00 72 00 69 00 6e 00 67 00 5d 00 24 00 [0-02] 2b 00 27 00 2e 00 27 00 2b 00 24 00 [0-02] 2b 00 27 00 2e 00 27 00 2b 00 24 00 [0-02] 2b 00 27 00 2e 00 27 00 2b 00 24 00 [0-02] 2b 00 24 00 [0-02] 3b 00 } 	condition:
