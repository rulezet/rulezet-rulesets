rule TrojanDownloader_Win32_Thoper_D{
	...
	strings :
		$a_01_0 = {b9 25 f2 00 00 66 89 4d fc 50 } 		$a_01_1 = {81 e9 6a 3b 00 00 66 89 4d fc } 		$a_03_2 = {57 b8 25 f2 00 00 68 ?? ?? ?? ?? 56 66 89 44 24 1c } 		$a_01_3 = {81 c1 36 79 00 00 66 89 4d fc } 	condition:
