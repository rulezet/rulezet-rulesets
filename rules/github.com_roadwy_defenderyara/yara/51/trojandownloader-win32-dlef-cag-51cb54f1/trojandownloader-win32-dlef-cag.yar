rule TrojanDownloader_Win32_Dlef_CAG{
	...
	strings :
		$a_02_0 = {64 a1 30 00 00 00 8b 40 0c ?? ?? 0c 8b 00 } 		$a_00_1 = {6b 6b 69 6c 6c 20 2f 69 6d 20 65 78 70 6c 6f 72 65 72 } 		$a_00_2 = {39 31 2e 32 30 37 2e 36 2e 31 32 32 } 	condition:
