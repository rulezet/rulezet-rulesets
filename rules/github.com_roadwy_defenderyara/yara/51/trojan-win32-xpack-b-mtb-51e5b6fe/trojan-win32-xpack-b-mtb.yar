rule Trojan_Win32_Xpack_B_MTB{
	...
	strings :
		$a_01_0 = {4f 6e 65 38 4e 65 6f } 		$a_01_1 = {54 77 6f 38 4e 65 6f } 		$a_01_2 = {54 68 72 38 4e 65 6f } 		$a_01_3 = {57 61 69 74 46 6f 72 53 69 6e 67 6c 65 4f 62 6a 65 63 74 } 	condition:
