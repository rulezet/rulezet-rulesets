rule Trojan_Win32_ClickFix_ZFA{
	...
	strings :
		$a_00_0 = {70 00 6f 00 77 00 65 00 72 00 73 00 68 00 65 00 6c 00 6c 00 } 		$a_00_1 = {2d 00 77 00 } 		$a_00_2 = {63 00 75 00 72 00 6c 00 } 		$a_00_3 = {2e 00 70 00 73 00 31 00 } 	condition:
