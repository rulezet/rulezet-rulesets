rule Trojan_BAT_Heracles_AMMB_MTB_2{
	...
	strings :
		$a_03_0 = {0a 13 06 02 73 ?? ?? 00 0a 13 07 11 07 75 ?? 00 00 01 11 06 75 ?? 00 00 01 16 73 ?? ?? 00 0a 13 08 19 13 14 2b a8 02 8e 69 17 da 17 d6 8d ?? 00 00 01 13 09 11 08 74 ?? 00 00 01 11 09 75 ?? 00 00 1b 16 11 09 75 ?? 00 00 1b 8e 69 6f ?? ?? 00 0a 13 0a 18 13 14 38 ?? ff ff ff 11 0a 17 da 17 d6 8d ?? 00 00 01 13 0b 11 09 74 ?? 00 00 1b 11 0b 74 ?? 00 00 1b 11 0a 28 ?? ?? 00 0a 17 13 14 38 } 		$a_03_1 = {25 11 04 75 ?? 00 00 01 1f 20 6f ?? ?? 00 0a 6f ?? ?? 00 0a 25 11 04 74 ?? 00 00 01 1f 10 6f ?? ?? 00 0a 6f ?? ?? 00 0a 13 05 } 		$a_01_2 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } 	condition:
