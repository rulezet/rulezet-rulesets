rule Ransom_Win32_BlackCat_ZA_MTB{
	...
	strings :
		$a_01_0 = {f1 d5 00 fa 4c 62 cc f4 0f 0b } 		$a_01_1 = {89 d3 89 c8 31 d2 f7 f6 8b 45 f0 0f b6 04 10 89 da 30 04 0b 41 39 cf } 		$a_03_2 = {8b 0e 8a 15 ?? ?? ?? ?? 88 14 01 ff 46 08 a2 } 	condition:
