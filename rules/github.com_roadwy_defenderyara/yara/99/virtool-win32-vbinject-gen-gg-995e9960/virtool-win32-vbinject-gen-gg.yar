rule VirTool_Win32_VBInject_gen_GG{
	...
	strings :
		$a_01_0 = {fc 14 f3 ff 00 fb 12 fc 0d } 		$a_01_1 = {f5 07 00 01 00 71 } 		$a_03_2 = {f5 40 00 00 00 f5 00 30 00 00 6c ?? ?? 6c ?? ?? 6c ?? ?? 0a } 		$a_03_3 = {f5 f8 00 00 00 aa f5 28 00 00 00 6c ?? ?? b2 aa } 	condition:
