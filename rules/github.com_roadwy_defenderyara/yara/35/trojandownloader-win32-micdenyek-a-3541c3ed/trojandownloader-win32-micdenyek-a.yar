rule TrojanDownloader_Win32_Micdenyek_A{
	...
	strings :
		$a_01_0 = {44 43 49 4d 5f 30 25 35 21 64 21 2e 6a 70 67 } 		$a_03_1 = {25 31 21 73 21 5c 25 32 21 73 ?? 2e 64 6c 6c } 		$a_00_2 = {62 79 74 65 73 3d 25 31 21 64 21 } 	condition:
