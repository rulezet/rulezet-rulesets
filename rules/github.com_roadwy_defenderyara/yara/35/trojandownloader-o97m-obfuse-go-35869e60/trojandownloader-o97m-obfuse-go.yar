rule TrojanDownloader_O97M_Obfuse_GO{
	...
	strings :
		$a_01_0 = {53 75 62 20 41 75 74 6f 4f 70 65 6e 28 29 } 		$a_03_1 = {2e 52 75 6e 25 20 28 [0-20] 2e 54 65 78 74 20 5f } 		$a_01_2 = {3d 20 56 42 41 2e 20 5f } 		$a_01_3 = {2e 54 65 78 74 } 	condition:
