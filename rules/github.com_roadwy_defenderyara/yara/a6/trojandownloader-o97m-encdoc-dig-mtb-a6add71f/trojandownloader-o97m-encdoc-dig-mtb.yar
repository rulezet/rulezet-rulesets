rule TrojanDownloader_O97M_EncDoc_DIG_MTB{
	...
	strings :
		$a_01_0 = {2f 64 73 2f 30 32 31 32 32 30 26 43 35 31 } 		$a_01_1 = {63 68 74 66 6a 2e 64 6c 6c } 		$a_03_2 = {43 3a 5c 67 6e 62 66 74 5c [0-04] 67 69 66 } 		$a_01_3 = {4a 4a 43 43 4a 4a } 	condition:
