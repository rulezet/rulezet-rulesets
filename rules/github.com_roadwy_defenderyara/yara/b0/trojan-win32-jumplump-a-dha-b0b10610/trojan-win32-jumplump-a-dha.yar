rule Trojan_Win32_Jumplump_A_dha{
	...
	strings :
		$a_02_0 = {66 3d 4d 5a e9 ?? ?? ?? ff } 		$a_02_1 = {48 81 ee 02 10 00 00 e9 ?? ?? ?? (ff|00) } 		$a_01_2 = {48 81 ec 10 04 00 00 e9 } 		$a_01_3 = {41 bf 38 68 0d 16 } 		$a_01_4 = {41 bf aa c5 e2 5d } 		$a_01_5 = {41 bf 08 87 1d 60 } 	condition:
