rule VirTool_Win32_VBInject_gen_GA{
	...
	strings :
		$a_03_0 = {3b c2 7f 0e c6 04 07 cc ?? ?? ?? ?? ?? 89 45 ec eb ee } 		$a_01_1 = {c7 45 a8 e8 00 00 00 89 7d a0 } 		$a_01_2 = {c7 45 a8 c3 00 00 00 89 7d a0 } 		$a_01_3 = {c7 45 a8 58 00 00 00 89 7d a0 } 	condition:
