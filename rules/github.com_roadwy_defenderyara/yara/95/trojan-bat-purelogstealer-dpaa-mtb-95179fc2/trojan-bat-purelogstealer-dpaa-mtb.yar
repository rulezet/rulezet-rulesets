rule Trojan_BAT_PureLogStealer_DPAA_MTB{
	...
	strings :
		$a_01_0 = {09 06 58 0d 06 17 58 0a 06 02 31 f4 } 		$a_03_1 = {20 00 01 00 00 14 14 14 6f ?? ?? 00 0a 26 11 04 07 5a 13 04 07 17 58 0b 07 02 31 d8 } 		$a_01_2 = {52 65 76 65 72 73 65 } 	condition:
