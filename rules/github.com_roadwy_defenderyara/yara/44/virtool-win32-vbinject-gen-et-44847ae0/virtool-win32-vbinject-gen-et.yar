rule VirTool_Win32_VBInject_gen_ET{
	...
	strings :
		$a_03_0 = {66 b9 ff 00 ?? ?? ?? ?? ?? ?? ?? ?? [0-08] 66 b9 d0 00 } 		$a_03_1 = {68 c2 8c 10 c5 68 [0-02] 40 00 } 		$a_03_2 = {68 d0 37 10 f2 68 [0-02] 40 00 } 		$a_03_3 = {68 c8 46 4a c5 68 [0-02] 40 00 } 	condition:
