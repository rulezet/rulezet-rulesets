rule TrojanDownloader_Win32_Small_OAG{
	...
	strings :
		$a_02_0 = {68 2f 00 10 15 6a 02 e8 ?? ?? ff ff 83 c4 08 6a 00 6a 00 6a 00 6a 00 6a 00 68 ?? 20 40 00 68 ?? 20 40 00 55 ff d0 } 		$a_00_1 = {6c 6f 61 64 73 2e 70 68 70 } 	condition:
