rule TrojanDownloader_BAT_AveMariaRAT_P_MTB{
	...
	strings :
		$a_01_0 = {8e 69 5d 91 02 11 04 91 61 d2 6f } 		$a_01_1 = {47 65 74 42 79 74 65 73 } 		$a_01_2 = {44 6f 77 6e 6c 6f 61 64 44 61 74 61 } 		$a_01_3 = {47 65 74 54 79 70 65 } 		$a_01_4 = {47 65 74 4d 65 74 68 6f 64 } 	condition:
