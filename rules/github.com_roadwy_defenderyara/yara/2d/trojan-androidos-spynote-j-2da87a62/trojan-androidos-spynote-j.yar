rule Trojan_AndroidOS_Spynote_J{
	...
	strings :
		$a_00_0 = {2f 65 78 69 74 2f 63 68 61 74 2f } 		$a_00_1 = {62 30 66 61 6c 73 65 } 		$a_00_2 = {4f 70 57 69 6e } 		$a_00_3 = {6e 75 6c 6c 20 26 20 6e 75 6c 6c } 		$a_00_4 = {50 41 4e 47 20 21 21 } 	condition:
