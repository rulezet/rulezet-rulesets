rule Backdoor_Linux_Gafgyt_A_MTB{
	...
	strings :
		$a_00_0 = {2f 78 35 34 2f 78 35 33 2f 78 36 66 2f 78 37 35 2f 78 37 32 2f 78 36 33 2f 78 36 35 2f 78 32 30 2f 78 34 35 2f 78 36 65 2f 78 36 37 2f 78 36 39 2f 78 36 65 2f 78 36 35 2f 78 32 30 2f 78 35 31 2f 78 37 35 2f 78 36 35 2f 78 37 32 2f 78 37 39 } 		$a_00_1 = {4b 49 4c 4c 41 4c 4c } 		$a_00_2 = {62 6f 74 6e 61 6d 65 3a } 		$a_00_3 = {64 61 79 7a 64 64 6f 73 2e 63 6f } 		$a_00_4 = {76 73 65 61 74 74 61 63 6b } 		$a_00_5 = {73 74 64 68 65 78 66 6c 6f 6f 64 } 		$a_00_6 = {6c 6f 6c 6f 6c 6f 6c 6f 6c 6f 6c } 	condition:
