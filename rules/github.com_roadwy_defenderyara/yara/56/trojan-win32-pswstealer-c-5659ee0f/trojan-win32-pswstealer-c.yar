rule Trojan_Win32_PswStealer_C{
	...
	strings :
		$a_00_0 = {63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 } 		$a_00_1 = {20 00 70 00 61 00 73 00 73 00 } 		$a_00_2 = {20 00 70 00 73 00 77 00 } 		$a_00_3 = {63 00 6f 00 70 00 79 00 } 	condition:
