rule HackTool_Linux_PTHToolkitGen_WW{
	...
	strings :
		$a_00_0 = {73 00 6d 00 62 00 68 00 61 00 73 00 68 00 } 		$a_00_1 = {2f 00 2f 00 } 		$a_00_2 = {2d 00 75 00 } 		$a_00_3 = {2d 00 61 00 } 		$a_00_4 = {2d 00 72 00 75 00 6e 00 61 00 73 00 } 	condition:
