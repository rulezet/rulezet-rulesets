rule Trojan_Win64_CobaltStrike_CCJL_MTB{
	...
	strings :
		$a_01_0 = {4f 4f 70 57 45 38 44 44 } 		$a_01_1 = {51 74 4f 66 31 33 38 4d } 		$a_01_2 = {55 50 68 4b 67 61 } 		$a_01_3 = {57 6a 59 42 6c 32 34 31 30 } 		$a_01_4 = {5a 57 6a 39 30 45 7a } 	condition:
