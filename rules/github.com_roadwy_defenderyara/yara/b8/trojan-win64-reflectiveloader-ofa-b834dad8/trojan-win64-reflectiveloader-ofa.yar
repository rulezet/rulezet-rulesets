rule Trojan_Win64_ReflectiveLoader_OFA{
	...
	strings :
		$a_01_0 = {5b bc 4a 6a } 		$a_01_1 = {5d 68 fa 3c } 		$a_01_2 = {8e 4e 0e ec } 		$a_01_3 = {aa fc 0d 7c } 		$a_01_4 = {54 ca af 91 } 		$a_01_5 = {b8 0a 4c 53 } 		$a_81_6 = {52 65 66 6c 65 63 74 69 76 65 4c 6f 61 64 65 72 } 	condition:
