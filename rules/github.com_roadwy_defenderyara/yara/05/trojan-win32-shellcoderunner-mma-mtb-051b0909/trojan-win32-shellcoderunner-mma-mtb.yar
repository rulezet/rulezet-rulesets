rule Trojan_Win32_ShellcodeRunner_MMA_MTB{
	...
	strings :
		$a_03_0 = {33 c0 5b 0f b6 34 10 33 f1 8a 8e ?? ?? ?? ?? 30 4c 07 40 0f b6 4c 07 40 40 83 f8 10 7c } 		$a_03_1 = {8b 55 14 8b c8 83 e1 ?? 8a 0c 11 30 0c 18 40 3b 45 1c 7c } 	condition:
