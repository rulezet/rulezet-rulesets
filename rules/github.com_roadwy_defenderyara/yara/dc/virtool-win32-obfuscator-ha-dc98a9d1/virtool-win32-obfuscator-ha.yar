rule VirTool_Win32_Obfuscator_HA{
	...
	strings :
		$a_03_0 = {c1 e8 10 83 c0 02 8d 80 ?? ?? ?? ?? ff e0 } 		$a_03_1 = {64 8b 15 18 00 00 00 41 52 [0-10] 5e 48 c7 46 14 } 		$a_01_2 = {c7 46 14 38 37 36 34 01 f0 } 		$a_01_3 = {0f 70 ca ff 0f 77 } 	condition:
