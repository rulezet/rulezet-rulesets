rule VirTool_BAT_AsmInject_A{
	...
	strings :
		$a_01_0 = {7b 4c 00 6f 00 61 00 64 00 65 00 72 00 2c 00 20 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 3d 00 31 00 2e 00 30 00 2e 00 30 00 2e 00 30 00 2c 00 20 00 43 00 75 00 6c 00 74 00 75 00 72 00 65 00 3d 00 6e 00 65 00 75 00 74 00 72 00 61 00 6c 00 2c 00 20 00 50 00 75 00 62 00 6c 00 69 00 63 00 4b 00 65 00 79 00 54 00 6f 00 6b 00 65 00 6e 00 3d 00 6e 00 75 00 6c 00 6c 00 } 		$a_01_1 = {49 6e 6a 65 63 74 69 6f 6e 4c 69 62 72 61 72 79 } 	condition:
