rule Trojan_Win32_LiteDuke_A_dha{
	...
	strings :
		$a_01_0 = {33 f6 56 57 56 56 56 b8 00 00 00 80 50 56 50 68 00 00 cf 00 56 b9 } 		$a_02_1 = {68 be dd 54 7e [0-06] e8 } 		$a_02_2 = {68 1a 0e 38 59 [0-06] e8 } 		$a_01_3 = {40 00 32 11 32 d0 } 	condition:
