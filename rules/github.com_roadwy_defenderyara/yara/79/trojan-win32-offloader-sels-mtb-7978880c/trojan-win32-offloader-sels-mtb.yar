rule Trojan_Win32_OffLoader_SELS_MTB{
	...
	strings :
		$a_80_0 = {2f 2f 77 69 73 68 73 6f 6e 2e 69 63 75 2f 69 64 6f 2e 70 68 70 } 		$a_80_1 = {2f 73 69 6c 65 6e 74 } 		$a_80_2 = {2f 77 65 61 6b 73 65 63 75 72 69 74 79 } 	condition:
