rule TrojanDownloader_Win32_Climetop_A{
	...
	strings :
		$a_03_0 = {89 c1 80 33 ?? 43 e2 fa c3 } 		$a_03_1 = {ff d0 83 3d ?? ?? ?? ?? 64 74 11 } 		$a_01_2 = {77 73 68 65 6c 6c 33 32 2e 64 6c 6c } 		$a_01_3 = {74 88 6a 00 6a 01 } 		$a_01_4 = {63 6f 6d 70 6c 69 74 65 2e 64 61 74 } 	condition:
