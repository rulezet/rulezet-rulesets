rule Trojan_Linux_FirewallOutHttpsBlock_FU2{
	...
	strings :
		$a_81_0 = {75 66 77 20 64 65 6e 79 20 6f 75 74 20 74 6f 20 61 6e 79 20 70 6f 72 74 20 34 34 33 } 		$a_81_1 = {75 66 77 20 64 65 6e 79 20 6f 75 74 20 68 74 74 70 73 } 	condition:
