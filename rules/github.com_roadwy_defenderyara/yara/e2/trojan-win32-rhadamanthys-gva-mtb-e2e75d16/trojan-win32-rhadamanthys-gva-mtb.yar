rule Trojan_Win32_Rhadamanthys_GVA_MTB{
	...
	strings :
		$a_01_0 = {ec 8b c5 eb } 		$a_02_1 = {8b 4c 24 38 33 cc e8 ?? ?? ?? ?? 83 c4 48 } 		$a_01_2 = {8b cd eb 02 8b 09 eb 02 } 		$a_01_3 = {0f be 08 eb 03 } 		$a_01_4 = {0f 9d c2 4a 8b c2 } 		$a_01_5 = {88 0a e9 98 } 	condition:
