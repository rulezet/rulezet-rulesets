rule TrojanDownloader_Win64_Stealer_WE_MTB{
	...
	strings :
		$a_03_0 = {42 0f b6 84 ?? ?? ?? ?? ?? 49 ff c0 ff c1 41 30 40 ?? 48 ff c2 49 ff c9 75 } 		$a_81_1 = {70 61 79 6c 6f 61 64 2e 62 69 6e } 		$a_81_2 = {6c 6f 61 64 65 72 2e 62 69 6e } 	condition:
