rule VirTool_Win32_Obfuscator_QR{
	...
	strings :
		$a_01_0 = {68 fd 46 3b bb } 		$a_01_1 = {68 4e fe 58 33 } 		$a_01_2 = {0f b7 08 81 e9 4d 5a 00 00 } 		$a_01_3 = {66 8f 40 16 90 0f b7 4b 06 } 		$a_03_4 = {f7 45 f8 04 00 00 00 0f 84 ?? ?? ?? ?? 90 18 53 } 	condition:
