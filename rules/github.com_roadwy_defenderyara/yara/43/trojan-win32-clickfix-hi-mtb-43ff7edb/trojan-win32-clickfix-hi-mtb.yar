rule Trojan_Win32_ClickFix_HI_MTB{
	...
	strings :
		$a_00_0 = {7c 00 69 00 65 00 78 00 20 00 23 00 } 		$a_00_1 = {70 00 6f 00 77 00 65 00 72 00 73 00 68 00 65 00 6c 00 6c 00 } 		$a_00_2 = {6d 00 73 00 68 00 74 00 61 00 } 	condition:
