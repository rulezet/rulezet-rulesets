rule Trojan_BAT_ClipBanker_DY_MTB{
	...
	strings :
		$a_01_0 = {4d 00 41 00 52 00 4b 00 45 00 54 00 49 00 4e 00 47 00 5f 00 53 00 45 00 4f 00 5f 00 41 00 44 00 56 00 45 00 52 00 54 00 49 00 53 00 49 00 4e 00 47 00 5f 00 50 00 52 00 4f 00 4d 00 4f 00 54 00 49 00 4f 00 4e 00 5f 00 49 00 43 00 4f 00 4e 00 5f 00 31 00 39 00 32 00 34 00 33 00 32 00 } 		$a_81_1 = {30 6b 30 30 30 68 32 32 32 5d 37 37 36 4b } 		$a_81_2 = {67 65 74 5f 43 75 72 72 65 6e 74 44 6f 6d 61 69 6e } 		$a_81_3 = {61 64 66 61 73 64 61 73 } 		$a_81_4 = {52 65 73 6f 6c 76 65 53 69 67 6e 61 74 75 72 65 } 		$a_81_5 = {67 65 74 5f 46 75 6c 6c 4e 61 6d 65 } 	condition:
