rule Ransom_Win64_LockFile_A_MTB{
	...
	strings :
		$a_81_0 = {65 6e 63 72 79 70 74 64 65 63 72 79 70 74 } 		$a_81_1 = {2e 72 75 73 74 73 6f 6d 77 61 72 65 } 		$a_00_2 = {20 70 61 79 20 } 		$a_00_3 = {2f 72 75 73 74 63 2f } 	condition:
