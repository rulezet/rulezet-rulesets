rule VirTool_Win32_CeeInject_gen_KW{
	...
	strings :
		$a_03_0 = {8b 46 28 03 45 ?? 89 87 b0 00 00 00 } 		$a_03_1 = {8b 4e 50 8b 56 34 8b 45 ?? 6a 40 68 00 30 00 00 } 		$a_01_2 = {3d 75 f2 1f 0f 74 07 3d 75 85 86 06 75 05 } 	condition:
