rule TrojanDownloader_Win32_Dofoil_gen_C{
	...
	strings :
		$a_01_0 = {68 72 6b 00 00 68 00 00 57 6f } 		$a_01_1 = {b0 68 aa 8b 45 fc ab b0 c3 aa } 		$a_03_2 = {e2 ea eb d4 61 89 c5 8d bb ?? ?? ?? ?? 03 80 78 01 00 00 8b 48 14 0b 48 18 74 28 } 	condition:
