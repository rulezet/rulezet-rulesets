rule TrojanDownloader_BAT_AgentTesla_ABD_MTB{
	...
	strings :
		$a_03_0 = {06 0a 02 06 28 ?? ?? ?? 06 0b 07 2a 90 0a 16 00 02 72 ?? ?? ?? 70 28 04 } 		$a_01_1 = {47 65 74 52 65 73 70 6f 6e 73 65 53 74 72 65 61 6d } 		$a_01_2 = {57 65 62 52 65 71 75 65 73 74 } 	condition:
