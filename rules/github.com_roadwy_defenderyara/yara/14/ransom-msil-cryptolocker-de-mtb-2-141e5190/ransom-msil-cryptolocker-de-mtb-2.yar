rule Ransom_MSIL_CryptoLocker_DE_MTB_2{
	...
	strings :
		$a_81_0 = {59 6f 75 72 20 66 69 6c 65 73 20 28 63 6f 75 6e 74 3a 20 6e 29 20 68 61 76 65 20 62 65 65 6e 20 65 6e 63 72 79 70 74 65 64 } 		$a_81_1 = {52 45 43 4f 56 45 52 5f 5f 46 49 4c 45 53 5f 5f 2e 6c 6f 63 6b 65 64 2e 74 78 74 } 		$a_81_2 = {44 69 73 61 62 6c 65 54 61 73 6b 4d 67 72 } 		$a_81_3 = {42 69 74 63 6f 69 6e 41 64 64 72 65 73 73 } 	condition:
