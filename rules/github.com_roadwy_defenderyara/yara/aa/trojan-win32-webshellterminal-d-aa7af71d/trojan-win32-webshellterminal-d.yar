rule Trojan_Win32_WebShellTerminal_D{
	...
	strings :
		$a_00_0 = {63 00 6d 00 64 00 } 		$a_02_1 = {26 00 65 00 63 00 68 00 6f 00 [0-02] 5b 00 ?? ?? 5d 00 26 00 63 00 64 00 26 00 65 00 63 00 68 00 6f 00 [0-02] 5b 00 ?? ?? 5d 00 } 	condition:
