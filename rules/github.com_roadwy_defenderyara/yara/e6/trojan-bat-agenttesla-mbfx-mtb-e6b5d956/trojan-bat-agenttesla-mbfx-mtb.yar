rule Trojan_BAT_AgentTesla_MBFX_MTB{
	...
	strings :
		$a_03_0 = {02 11 04 09 6f ?? 00 00 0a 13 05 08 11 04 09 11 05 } 		$a_01_1 = {70 61 74 68 6f 6c 6f 67 69 73 74 2e 64 } 		$a_01_2 = {38 32 33 34 42 31 32 31 38 34 32 42 } 	condition:
