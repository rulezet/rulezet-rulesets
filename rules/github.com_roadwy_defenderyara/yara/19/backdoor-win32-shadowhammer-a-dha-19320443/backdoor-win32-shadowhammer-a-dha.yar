rule Backdoor_Win32_ShadowHammer_A_dha{
	...
	strings :
		$a_03_0 = {6a 40 68 00 10 00 00 68 00 ?? ?? 00 6a 00 ff 15 } 		$a_03_1 = {ad ab e2 fc 58 05 ?? ?? 00 00 ff d0 } 		$a_00_2 = {41 53 55 53 54 65 4b 20 43 6f 6d 70 75 74 65 72 20 49 6e 63 2e 31 } 	condition:
