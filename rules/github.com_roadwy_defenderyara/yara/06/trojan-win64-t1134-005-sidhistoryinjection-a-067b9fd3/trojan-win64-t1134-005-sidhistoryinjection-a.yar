rule Trojan_Win64_T1134_005_SidHistoryInjection_A{
	...
	strings :
		$a_01_0 = {73 00 69 00 64 00 3a 00 3a 00 61 00 64 00 64 00 } 		$a_01_1 = {6b 00 65 00 72 00 62 00 65 00 72 00 6f 00 73 00 3a 00 3a 00 67 00 6f 00 6c 00 64 00 65 00 6e 00 } 	condition:
