rule VirTool_Win32_Meterpreter_J_MTB{
	...
	strings :
		$a_02_0 = {8b 0e 20 85 c0 84 84 46 02 00 00 6a 99 ff ?? 83 c4 3d 33 c0 } 		$a_00_1 = {83 c4 04 01 c0 d0 13 8b 4d 10 8b ca 8c 50 51 52 } 		$a_00_2 = {21 43 50 a4 f8 73 09 } 	condition:
