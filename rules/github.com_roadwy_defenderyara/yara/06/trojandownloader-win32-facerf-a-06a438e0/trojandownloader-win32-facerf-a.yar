rule TrojanDownloader_Win32_Facerf_A{
	...
	strings :
		$a_00_0 = {2a 65 78 65 2d 65 78 65 2a } 		$a_00_1 = {67 73 70 63 32 2e 65 78 65 00 } 		$a_03_2 = {3c 01 0f 85 ?? ?? ?? ?? 68 b8 0b 00 00 e8 } 		$a_03_3 = {3d 00 c8 00 00 0f 86 ?? ?? ?? ?? 6a 06 } 	condition:
