rule Trojan_BAT_AgentTesla_ICZ_MTB{
	...
	strings :
		$a_01_0 = {11 07 11 01 02 11 01 91 11 03 61 d2 9c 38 } 		$a_01_1 = {00 43 6c 61 73 73 4c 69 62 72 61 72 79 00 } 		$a_81_2 = {70 6b 6f 77 65 6b 72 73 68 6b 65 6b 6c 6c } 	condition:
