rule Trojan_Win32_LaplasClipper_E_MTB{
	...
	strings :
		$a_01_0 = {8d 1c 0f f2 } 		$a_03_1 = {8d 1c 23 f2 90 09 04 00 83 34 24 } 		$a_01_2 = {23 c3 8b c9 } 		$a_01_3 = {f7 d0 c1 cb } 		$a_01_4 = {8b 1c 24 c1 e6 } 		$a_01_5 = {8d 0c 21 0f ba f0 } 		$a_01_6 = {8d 1c 23 23 c1 } 		$a_01_7 = {89 0c 24 8d 1c 23 } 	condition:
