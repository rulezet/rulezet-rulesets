rule Trojan_Win64_TigerCrypt_A_dha{
	...
	strings :
		$a_01_0 = {43 72 79 70 74 6f 72 49 6e 74 65 72 66 61 63 65 40 40 } 		$a_01_1 = {43 72 79 70 74 6f 72 58 6f 72 40 40 } 		$a_01_2 = {43 72 79 70 74 6f 72 44 45 53 40 40 } 	condition:
