rule Backdoor_Win32_NetWiredRC_E{
	...
	strings :
		$a_01_0 = {aa aa aa aa aa aa aa 81 } 		$a_03_1 = {02 64 8b 0d 18 00 00 00 81 ?? ?? ?? ?? 02 81 } 		$a_03_2 = {02 8b 49 30 81 ?? ?? ?? ?? 02 } 		$a_01_3 = {02 02 59 02 90 81 } 		$a_00_4 = {4d 53 56 42 56 4d 36 30 2e 44 4c 4c } 	condition:
