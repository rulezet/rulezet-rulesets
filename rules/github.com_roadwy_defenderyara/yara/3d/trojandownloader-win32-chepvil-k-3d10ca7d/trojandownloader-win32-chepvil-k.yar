rule TrojanDownloader_Win32_Chepvil_K{
	...
	strings :
		$a_00_0 = {2f 66 2f 67 2e 70 68 70 } 		$a_00_1 = {0f be 45 00 0f be 75 01 33 f0 b8 00 00 00 00 76 14 } 		$a_02_2 = {0f be 40 01 8b 95 ?? fc ff ff 0f be 12 31 d0 89 85 ?? fc ff ff } 	condition:
