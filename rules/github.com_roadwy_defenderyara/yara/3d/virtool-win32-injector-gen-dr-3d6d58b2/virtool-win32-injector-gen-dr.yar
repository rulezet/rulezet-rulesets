rule VirTool_Win32_Injector_gen_DR{
	...
	strings :
		$a_03_0 = {03 7f 3c 6a 40 68 00 30 00 00 ff 77 50 ff 77 34 ff b5 ?? ?? ?? ?? e8 } 		$a_03_1 = {46 66 3b 77 06 72 ?? 8b 85 ?? ?? ?? ?? 03 47 28 } 		$a_03_2 = {ff ff 02 00 01 00 90 09 04 00 c7 85 } 	condition:
