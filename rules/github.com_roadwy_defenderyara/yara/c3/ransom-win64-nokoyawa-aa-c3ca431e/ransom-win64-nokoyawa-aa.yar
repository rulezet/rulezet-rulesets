rule Ransom_Win64_Nokoyawa_AA{
	...
	strings :
		$a_01_0 = {f1 d5 00 fa 4c 62 cc f4 0f 0b } 		$a_01_1 = {3d 7c c4 8c 7c } 		$a_01_2 = {3d 89 28 f0 d6 } 		$a_01_3 = {3d 15 b7 7b c2 } 		$a_01_4 = {3d 26 b4 80 7c } 		$a_01_5 = {3d b5 99 f2 11 } 		$a_01_6 = {3d 95 39 fb 78 } 	condition:
