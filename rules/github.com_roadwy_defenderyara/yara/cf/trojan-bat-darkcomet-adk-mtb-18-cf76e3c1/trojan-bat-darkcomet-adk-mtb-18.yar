rule Trojan_BAT_DarkComet_ADK_MTB_18{
	...
	strings :
		$a_03_0 = {13 05 08 25 13 0a 2c 06 11 0a 8e 69 2d 06 16 e0 13 06 2b 0a 11 0a 16 8f ?? ?? ?? 01 13 06 11 05 25 13 0a 2c 06 11 0a 8e 69 2d 06 16 e0 13 07 2b 0a 11 0a 16 8f ?? ?? ?? 01 13 07 11 06 d3 11 07 d3 08 8e 69 11 05 8e 69 28 ?? ?? ?? 06 13 04 16 e0 13 07 16 e0 13 06 00 11 04 16 32 0a 11 05 8e 69 11 04 fe 04 2b 01 17 13 0b 11 0b 2d 87 } 	condition:
		((#a_03_0  & 1)*1) >=1
