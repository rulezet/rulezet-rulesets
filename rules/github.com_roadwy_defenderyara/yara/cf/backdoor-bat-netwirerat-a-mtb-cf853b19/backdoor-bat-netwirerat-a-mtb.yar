rule Backdoor_BAT_NetwireRAT_A_MTB{
	...
	strings :
		$a_03_0 = {20 00 01 00 00 14 14 17 8d ?? 00 00 01 25 16 02 a2 28 } 		$a_01_1 = {07 08 09 28 } 		$a_01_2 = {00 06 d2 06 28 } 		$a_01_3 = {59 1c 58 0d } 		$a_01_4 = {06 17 58 0a } 		$a_01_5 = {08 1a 59 1b 58 0c } 	condition:
