rule Trojan_Win32_Alureon_FK{
	...
	strings :
		$a_01_0 = {c6 45 f0 e9 ab 56 e8 } 		$a_01_1 = {3c 0d 75 04 c6 07 00 47 80 3f 0a } 		$a_03_2 = {74 70 80 3f 2f be ?? ?? ?? ?? 6a 01 75 0f } 		$a_01_3 = {50 75 72 70 6c 65 48 61 7a 65 } 	condition:
