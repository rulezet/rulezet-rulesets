rule Backdoor_Linux_Tsunami_H_xp{
	...
	strings :
		$a_01_0 = {73 70 6f 6f 66 73 6d } 		$a_01_1 = {67 65 74 73 70 6f 6f 66 73 } 		$a_01_2 = {6b 69 6c 6c 61 6c 6c } 		$a_01_3 = {74 73 75 6e 61 6d 69 } 		$a_01_4 = {6b 61 69 74 65 6e 2e 63 } 	condition:
