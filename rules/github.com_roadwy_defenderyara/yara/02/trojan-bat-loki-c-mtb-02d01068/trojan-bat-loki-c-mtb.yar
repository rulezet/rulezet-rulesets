rule Trojan_BAT_Loki_C_MTB{
	...
	strings :
		$a_01_0 = {06 1a 58 0a } 		$a_01_1 = {11 04 17 58 } 		$a_03_2 = {06 16 08 74 ?? ?? ?? 1b 06 1a } 		$a_01_3 = {0b 07 07 5a 1a 5a 8d } 		$a_03_4 = {01 0d 08 74 ?? ?? ?? 1b 1a 09 74 ?? ?? ?? 1b 16 09 75 ?? ?? ?? 1b 8e 69 28 } 	condition:
