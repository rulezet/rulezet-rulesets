rule Backdoor_Win32_Wodhast_A{
	...
	strings :
		$a_01_0 = {4c 4c 5f 53 54 41 52 54 55 50 } 		$a_01_1 = {54 5f 50 52 4f 50 } 		$a_01_2 = {5b 57 5d 20 4d 75 74 65 78 } 		$a_01_3 = {63 6d 64 5f 69 64 } 		$a_00_4 = {73 63 72 65 65 6e 73 68 6f 74 } 	condition:
