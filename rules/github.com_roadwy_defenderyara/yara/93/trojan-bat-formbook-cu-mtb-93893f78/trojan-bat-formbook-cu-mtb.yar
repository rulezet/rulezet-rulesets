rule Trojan_BAT_FormBook_CU_MTB{
	...
	strings :
		$a_03_0 = {02 8e 69 17 59 91 1f ?? 61 18 } 		$a_01_1 = {02 8e 69 17 59 fe 02 16 fe 01 } 		$a_01_2 = {61 06 09 91 16 } 		$a_01_3 = {02 8e 69 17 58 8d } 		$a_01_4 = {02 8e 69 17 59 28 } 	condition:
