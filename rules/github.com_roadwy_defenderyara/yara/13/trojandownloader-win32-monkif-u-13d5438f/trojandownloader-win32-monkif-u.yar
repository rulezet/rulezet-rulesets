rule TrojanDownloader_Win32_Monkif_U{
	...
	strings :
		$a_03_0 = {8a 04 0e 2a c2 2c ?? 42 3b 54 24 10 88 01 7c } 		$a_03_1 = {33 c0 8a c8 80 e9 ?? 30 88 ?? ?? ?? ?? 40 3d ?? ?? ?? ?? 7c } 		$a_01_2 = {6d 73 79 75 76 2e 64 6c 6c 00 45 78 70 6f 72 74 31 00 } 	condition:
