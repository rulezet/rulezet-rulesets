rule Trojan_BAT_LummaStealer_GTB_MTB{
	...
	strings :
		$a_01_0 = {13 06 08 20 b7 5c 8a 00 6a 5e 26 16 13 0a 2b 2b 11 05 11 0a 8f 18 00 00 01 25 47 08 d2 61 d2 52 11 0a 20 ff 00 00 00 5f 2d 0b 08 08 5a 20 b7 5c 8a 00 6a 5e 0c 11 0a 17 58 13 0a 11 0a 11 05 8e 69 32 cd } 		$a_80_1 = {44 6f 77 6e 6c 6f 61 64 65 72 41 70 70 2e 65 78 65 } 		$a_01_2 = {54 6f 42 61 73 65 36 34 53 74 72 69 6e 67 } 		$a_01_3 = {61 63 61 38 35 63 2d 37 31 32 34 2d 34 37 33 64 2d 61 32 65 63 2d 32 36 39 35 66 64 66 30 38 38 38 65 } 	condition:
