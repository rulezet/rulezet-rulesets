rule TrojanDownloader_Win32_Kredak{
	...
	strings :
		$a_01_0 = {74 68 61 69 64 72 69 76 65 72 2e 6e 65 74 } 		$a_01_1 = {25 73 5c 6f 2e 74 78 74 } 		$a_01_2 = {25 73 2f 68 5f 76 2e 68 74 6d 6c } 		$a_01_3 = {5b 41 4b 45 44 21 5d } 	condition:
