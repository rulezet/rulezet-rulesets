rule VirTool_Win32_CeeInject_AAR_bit{
	...
	strings :
		$a_01_0 = {8a 4c 24 14 03 c3 03 c5 8a 10 32 d1 43 81 fb da 04 00 00 88 10 } 		$a_03_1 = {03 c8 03 c3 90 09 0a 00 a1 ?? ?? ?? ?? b9 } 		$a_01_2 = {3d 4e e6 40 bb } 		$a_01_3 = {53 55 55 53 } 	condition:
