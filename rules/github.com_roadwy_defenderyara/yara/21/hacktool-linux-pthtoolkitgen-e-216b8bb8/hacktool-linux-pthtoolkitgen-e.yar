rule HackTool_Linux_PthToolKitGen_E{
	...
	strings :
		$a_00_0 = {70 00 79 00 74 00 68 00 6f 00 6e 00 } 		$a_00_1 = {2d 00 2d 00 6c 00 6d 00 3d 00 } 		$a_00_2 = {2d 00 2d 00 6e 00 74 00 3d 00 } 		$a_00_3 = {2d 00 74 00 20 00 } 	condition:
