rule TrojanSpy_Win32_Ursnif_gen_A{
	...
	strings :
		$a_01_0 = {73 6f 66 74 3d 25 75 26 76 65 72 73 69 6f 6e 3d 25 75 26 75 73 65 72 3d 25 30 38 78 25 30 38 78 25 30 38 78 25 30 38 78 26 73 65 72 76 65 72 3d 25 75 26 69 64 3d 25 75 26 63 72 63 3d 25 78 } 		$a_01_1 = {40 53 4f 43 4b 53 3d 2a 40 } 		$a_01_2 = {54 6f 72 43 6c 69 65 6e 74 } 		$a_01_3 = {54 6f 72 43 72 63 } 		$a_01_4 = {2e 6f 6e 69 6f 6e 2f } 	condition:
