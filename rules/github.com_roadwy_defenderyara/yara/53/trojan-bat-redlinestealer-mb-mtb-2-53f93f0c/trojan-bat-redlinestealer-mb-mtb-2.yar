rule Trojan_BAT_RedLineStealer_MB_MTB_2{
	...
	strings :
		$a_80_0 = {47 65 74 54 79 70 65 } 		$a_80_1 = {47 65 74 53 74 72 69 6e 67 } 		$a_80_2 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } 		$a_80_3 = {57 65 62 43 6c 69 65 6e 74 } 		$a_80_4 = {44 6f 77 6e 6c 6f 61 64 46 69 6c 65 } 		$a_80_5 = {4d 44 35 43 72 79 70 74 6f 53 65 72 76 69 63 65 50 72 6f 76 69 64 65 72 } 		$a_80_6 = {54 72 69 70 6c 65 44 45 53 43 72 79 70 74 6f 53 65 72 76 69 63 65 50 72 6f 76 69 64 65 72 } 		$a_80_7 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } 		$a_00_8 = {d2 f0 a4 9d 82 47 f3 24 19 a6 76 bc 66 ef 7b e2 0a 77 4a cd be 50 ae c8 1c 20 37 2f b2 55 9f 7e ae 97 88 93 e0 a3 31 fa ae 97 88 93 e0 a3 31 fa ae 97 88 93 e0 a3 31 fa ec b5 20 83 24 75 01 67 f4 7e be 23 ad d6 44 53 79 ab 23 e4 b1 5e 02 78 09 e8 94 79 50 e2 49 a4 6e 80 ee 08 a7 51 ec 7f 2a 2d f8 85 d9 23 98 ba 38 b0 4f 51 60 e0 fa 28 c3 a2 53 23 28 4e 93 f3 61 7d 42 20 89 21 2a 77 de fc 23 91 e5 57 f7 ce 5c 1e 47 60 f1 88 5b 3b 16 aa de 0c 5f 38 a9 c1 ad 37 ad 09 4c b7 e8 35 ed 75 06 ed e7 e2 25 52 cf ce e3 0d b6 b4 5b b3 b8 12 91 60 2a 26 c7 e8 f5 0b 84 5d 8d 50 84 ae 3c ce a3 64 } 	condition:
