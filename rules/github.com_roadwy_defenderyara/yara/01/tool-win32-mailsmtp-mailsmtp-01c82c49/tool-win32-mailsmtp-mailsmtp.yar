rule Tool_Win32_MailSmtp__MailSmtp{
	...
	strings :
		$a_81_0 = {48 45 4c 4f } 		$a_81_1 = {45 48 4c 4f } 		$a_81_2 = {32 35 30 20 4f 4b } 		$a_81_3 = {44 41 54 41 0d 0a } 		$a_81_4 = {52 43 50 54 20 54 4f 3a 3c } 		$a_81_5 = {4d 41 49 4c 20 46 52 4f 4d 3a 3c } 	condition:
