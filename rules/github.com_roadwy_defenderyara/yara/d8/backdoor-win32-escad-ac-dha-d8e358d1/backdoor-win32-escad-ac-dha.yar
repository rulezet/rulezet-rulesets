rule Backdoor_Win32_Escad_AC_dha{
	...
	strings :
		$a_01_0 = {52 53 52 43 5f 48 54 4d 4c } 		$a_01_1 = {52 53 52 43 5f 4a 50 47 } 		$a_01_2 = {52 53 52 43 5f 57 41 56 } 		$a_01_3 = {8a 0c 18 80 f1 63 88 0c 18 8b 4d 00 40 3b c1 72 ef } 	condition:
