rule Trojan_Win64_IcedID_MSD_MTB{
	...
	strings :
		$a_03_0 = {0f b6 04 01 8b 8c 24 ?? ?? ?? ?? eb 15 } 		$a_00_1 = {33 c8 8b c1 eb a6 } 		$a_03_2 = {48 63 0c 24 48 8b 94 24 ?? ?? ?? ?? e9 } 		$a_00_3 = {88 04 0a e9 } 		$a_00_4 = {55 6e 73 61 64 6a 6b 62 61 73 66 } 	condition:
