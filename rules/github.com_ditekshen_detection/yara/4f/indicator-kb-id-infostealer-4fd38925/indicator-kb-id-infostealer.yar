rule INDICATOR_KB_ID_Infostealer {
    ...
    strings:
        ...
        $account762 = "digidoctorau@gmail.com" ascii wide nocase         $account763 = "hrsimon59@gmail.com"  ascii wide nocase         $account764 = "mene@testproeg.com" ascii wide nocase
        ...
        $account792 = "merchandise@enche.com" ascii wide nocase         $account793 = "spam-h@hgnet.net.br" ascii wide nocase         $account794 = "wealthmyson@yandex.com" ascii wide nocase         $account795 = "andres.galarraga@sismode.com" ascii wide nocase         $account796 = "saleseuropower@yandex.com" ascii wide nocase         $account797 = "info@starkgulf.com" ascii wide nocase         $account798 = "etopical@bojtai.club" ascii wide nocase         $account799 = "fernando@digitaldirecto.es" ascii wide nocase         $account800 = "baerbelscheibll1809@gmail.com" ascii wide nocase         $account801 = "dashboard@grandamishabot.ru" ascii wide nocase         $account802 = "logs@grandamishabot.ru" ascii wide nocase         $account803 = "shan@farm-finn.com" ascii wide nocase         $account804 = "info@starkgulf.com" ascii wide nocase         $account805 = "netline@netjul.shop" ascii wide nocase         $account806 = "kendakenda@karanex.com" ascii wide nocase         $account807 = "forrest@prinutrition.com" ascii wide nocase         $account808 = "techorigin4560@gmail.com" ascii wide nocase         $account889 = "ifee@richetch.ltd" ascii wide nocase         $account890 = "davidchuzy@yandex.com" ascii wide nocase         $account891 = "endrit.neon@mail.com" ascii wide nocase         $account892 = "muhasebe@yekamuhendislik.com" ascii wide nocase         $account893 = "kplastik1@yandex.com" ascii wide nocase         $account894 = "admin@aninditaeng.net" ascii wide nocase         $account895 = "pmolemans@tranedico.nl" ascii wide nocase         $account896 = "jackjohnson64161@yandex.com" ascii wide nocase         $account897 = "n.mackey@itelcom.net.au" ascii wide nocase     condition:
        any of them
}