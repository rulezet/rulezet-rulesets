rule INDICATOR_TOOL_PWS_Mimikatz {
    ...
    strings:
        ...
        $s5 = "mimikatz" ascii
        $s6 = { 6d 00 69 00 6d 00 69 00 6b 00 61 00 74 00 7a }          $s7 = { 5c 00 6d 00 69 00 6d 00 69 00 64 00 72 00 76 }          $s8 = { 6d 00 69 00 6d 00 69 00 64 00 72 00 76 }                $s9 = "Lecture KIWI_MSV1_0_" ascii
