...
strings:
    $magic1 = { 7b 5c 72 74 30 31 }     $magic2 = { 7b 5c 72 74 66 31 }     $magic3 = { 7b 5c 72 74 78 61 33 }     $author1 = { 4A 6F 68 6E 20 44 6F 65 }     $author2 = { 61 75 74 68 6f 72 20 53 74 6f 6e 65 }     $string1 = { 44 30 [16] 43 46 [23] 31 31 45 }
