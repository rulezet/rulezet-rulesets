rule legion_777
{
    ...
    strings:
        ...
        $s2 = "read_this_file.txt" wide         $s3 = "seven_legion@india.com"         $s4 = {46 4f 52 20 44 45 43 52 59 50 54 20 46 49 4c 45 53 0d 0a 53 45 4e 44 20 4f
               4e 45 20 46 49 4c 45 20 49 4e 20 45 2d 4d 41 49 4c 0d 0a 73 65 76 65 6e 5f
               6c 65 67 69 6f 6e 40 69 6e 64 69 61 2e 63 6f 6d }         $s5 = "%s._%02i-%02i-%02i-%02i-%02i-%02i_$%s$.777" 
    condition:
        4 of ($s*)
}