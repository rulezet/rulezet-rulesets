rule RANSOM_Magniber_ISO_Jan23
{
	...
	strings:
		...
		$magic = {43 44 30 30 31} 		$tool = {55 4C 54 52 41 49 53 4F 00 39 2E 37 2E 36 2E 33 38 32 39} 		
        	$msiMagic = {D0 CF 11 E0 A1 B1 1A E1}
        	$dosString = "!This program cannot be run in DOS mode" ascii         	$lnkMagic = {4C 00 00 00}
