rule PUA_VULN_Driver_Razerinc_Rzpnk_Rzpnk_16E2_RID3628 : DEMO EXE FILE {
   ...
   strings:
      ...
      $ = { 00 46 00 69 00 6c 00 65 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e [1-8] 00 31 00 2e 00 30 00 2e 00 31 00 32 00 2e 00 33 00 31 00 33 00 37 } 
      $ = { 00 50 00 72 00 6f 00 64 00 75 00 63 00 74 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e [1-8] 00 31 00 2e 00 30 00 2e 00 31 00 32 00 2e 00 33 00 31 00 33 00 37 } 
