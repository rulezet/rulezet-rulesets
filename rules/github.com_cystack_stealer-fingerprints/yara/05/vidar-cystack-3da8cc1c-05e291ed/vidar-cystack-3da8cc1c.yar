rule Vidar_cystack_3da8cc1c
{
    meta:
        family = "Vidar"
        fingerprint_id = "cystack_3da8cc1c"
    ...
    strings:
        ...
        $key_13 = "Need for Speed:" ascii
        $key_14 = "Path:" ascii
        $key_15 = "Processor:" ascii
        $key_16 = "RAM:" ascii
        $key_17 = "Street Fighter V:" ascii
        $key_18 = "Super Street Fighter IV:" ascii
