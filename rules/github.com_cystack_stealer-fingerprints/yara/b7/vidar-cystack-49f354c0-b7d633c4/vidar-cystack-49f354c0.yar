rule Vidar_cystack_49f354c0
{
    meta:
        family = "Vidar"
        fingerprint_id = "cystack_49f354c0"
    ...
    strings:
        ...
        $key_13 = "NHRA Championship Drag Racing:" ascii
        $key_14 = "Path:" ascii
        $key_15 = "Processor:" ascii
        $key_16 = "RAM:" ascii
        $key_17 = "Street Outlaws 2:" ascii
        $key_18 = "The Walking Dead:" ascii
