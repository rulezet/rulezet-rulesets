rule Vidar_cystack_404e3028
{
    meta:
        family = "Vidar"
        fingerprint_id = "cystack_404e3028"
    ...
    strings:
        ...
        $key_13 = "Office Simulator:" ascii
        $key_14 = "Path:" ascii
        $key_15 = "Processor:" ascii
        $key_16 = "RAM:" ascii
        $key_17 = "SpongeBob SquarePants:" ascii
        $key_18 = "There Is No Game:" ascii
