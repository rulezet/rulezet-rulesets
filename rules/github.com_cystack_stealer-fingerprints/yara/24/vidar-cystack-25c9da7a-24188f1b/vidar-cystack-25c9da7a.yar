rule Vidar_cystack_25c9da7a
{
    meta:
        family = "Vidar"
        fingerprint_id = "cystack_25c9da7a"
    ...
    strings:
        ...
        $key_17 = "RAM:" ascii
        $key_18 = "Resident Evil 4:" ascii
        $key_19 = "Resident Evil 5:" ascii
        $key_20 = "Session:" ascii
        $key_21 = "The Incredible Adventures of Van Helsing:" ascii
