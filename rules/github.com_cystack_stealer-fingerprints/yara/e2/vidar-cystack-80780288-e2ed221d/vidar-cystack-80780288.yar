rule Vidar_cystack_80780288
{
    meta:
        family = "Vidar"
        fingerprint_id = "cystack_80780288"
    ...
    strings:
        ...
        $key_7 = "HWID:" ascii
        $key_8 = "IP:" ascii
        $key_9 = "Jewel Quest Mysteries:" ascii
        ...
        $key_16 = "RAM:" ascii
        $key_17 = "RollerCoaster Tycoon 3:" ascii
        $key_18 = "The Treasures of Mystery Island:" ascii
