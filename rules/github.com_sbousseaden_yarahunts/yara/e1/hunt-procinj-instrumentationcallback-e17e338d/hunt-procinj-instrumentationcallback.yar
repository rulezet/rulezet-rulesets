...
strings:
 ...
 $mv5 = {(49 89 CA|4C 8B D1) B8 0F 01 00 00 0F 05 C3}  $spi1 = "NtSetInformationProcess" xor
 $spi2 = "NtSetInformationProcess" wide xor
 $spi3 = {(49 89 CA|4C 8B D1) B8 1C 00 00 00 0F 05 C3}  $picb = {BA 28 00 00 00}  $ss1 = {41 52 50 53 55 57 56 54 41 54 41 55 41 56 41 57}   $ss2 = {41 5F 41 5E 41 5D 41 5C 5C 5E 5F 5D 5B 58 41 5A}   $ss3 = {49 89 CA 0F 05 C3} condition: uint16(0)==0x5a4d and $picb and 1 of ($mv*) and 1 of ($spi*) and 1 of ($ss*)
}