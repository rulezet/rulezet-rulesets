rule rule_pyinstaller_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string4_pyinstaller_greyware_tool_keyword = /pyinstaller\s.{0,100}\.py/ nocase ascii wide
                        $string5_pyinstaller_greyware_tool_keyword = /pyinstaller.{0,100}\s\-\-onefile\s\-\-add\-data\s/ nocase ascii wide
