rule rule_GoToMyPC_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string5_GoToMyPC_greyware_tool_keyword = /\\AppData\\Local\\Temp\\.{0,100}\\gosetup\.exe/ nocase ascii wide
                        $string6_GoToMyPC_greyware_tool_keyword = /\\AppData\\Local\\Temp\\.{0,100}\\GoToOpener\.msi/ nocase ascii wide
                        ...
                        $string22_GoToMyPC_greyware_tool_keyword = /\\GoToMyPC\\.{0,100}\\.{0,100}\\g2ldr\.log/ nocase ascii wide
                        ...
                        $string45_GoToMyPC_greyware_tool_keyword = /G2MScrUtil64\.exe.{0,100}\/cr/ nocase ascii wide
                        $string46_GoToMyPC_greyware_tool_keyword = /g2mui\.exe.{0,100}\/cr/ nocase ascii wide
                        $string47_GoToMyPC_greyware_tool_keyword = /GoTo\sMyPC\sInstaller\.exe/ nocase ascii wide
                        $string48_GoToMyPC_greyware_tool_keyword = /GOTO\sMYPC\sINSTALLER\.EXE\-.{0,100}\.pf/ nocase ascii wide
                        $string49_GoToMyPC_greyware_tool_keyword = /GoTo\sOpener\.exe\s/ nocase ascii wide
                        $string50_GoToMyPC_greyware_tool_keyword = /GOTO\sOPENER\.EXE\-.{0,100}\.pf/ nocase ascii wide
                        $string51_GoToMyPC_greyware_tool_keyword = /Goto\.exe.{0,100}\?type\=crashpad\-handler/ nocase ascii wide
                        ...
                        $string55_GoToMyPC_greyware_tool_keyword = /GoToScrUtils\.exe.{0,100}\/cr/ nocase ascii wide
