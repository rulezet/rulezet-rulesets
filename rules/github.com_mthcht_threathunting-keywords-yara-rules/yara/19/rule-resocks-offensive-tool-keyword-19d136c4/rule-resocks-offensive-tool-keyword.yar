rule rule_resocks_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string2_resocks_offensive_tool_keyword = /\/resocks\s.{0,1000}\s\-\-key\s/
                        ...
                        $string5_resocks_offensive_tool_keyword = /\/resocks_.{0,1000}_Linux_x86_64\.tar\.gz/
                        $string6_resocks_offensive_tool_keyword = /\/resocks_.{0,1000}_macOS_arm64\.tar\.gz/ nocase ascii wide
                        $string7_resocks_offensive_tool_keyword = /\/resocks_Darwin_x86_64\.tar\.gz/
                        $string8_resocks_offensive_tool_keyword = /\/resocks_Linux_.{0,1000}\.tar\.gz/
                        ...
                        $string24_resocks_offensive_tool_keyword = /Connect\sback\sto\san\s.{0,1000}\slistener\sand\srelay\sthe\sSOCKS5\straffic/ nocase ascii wide
