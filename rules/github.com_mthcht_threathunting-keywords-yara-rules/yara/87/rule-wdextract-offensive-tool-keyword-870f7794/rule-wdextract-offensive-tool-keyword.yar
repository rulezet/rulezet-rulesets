rule rule_WDExtract_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string42_WDExtract_offensive_tool_keyword = /wdextract\s.{0,1000}\:\\.{0,1000}\\.{0,1000}\.vdm/ nocase ascii wide
                        $string43_WDExtract_offensive_tool_keyword = /wdextract\s.{0,1000}\\mrt\.exe/ nocase ascii wide
