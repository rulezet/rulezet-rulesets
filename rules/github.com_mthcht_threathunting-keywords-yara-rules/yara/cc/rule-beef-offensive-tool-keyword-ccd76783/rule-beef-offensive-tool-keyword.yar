rule rule_beef_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_beef_offensive_tool_keyword = /\/beef\/extensions\/.{0,1000}\.rb/ nocase ascii wide
                        ...
                        $string10_beef_offensive_tool_keyword = /\/detect_antivirus\/.{0,1000}\.js/ nocase ascii wide
                        $string11_beef_offensive_tool_keyword = /\/detect_antivirus\/.{0,1000}\.rb/ nocase ascii wide
                        $string12_beef_offensive_tool_keyword = /\/hijack_opener\/.{0,1000}\.js/ nocase ascii wide
                        $string13_beef_offensive_tool_keyword = /\/hijack_opener\/.{0,1000}\.rb/ nocase ascii wide
                        $string14_beef_offensive_tool_keyword = /\/man_in_the_browser\/.{0,1000}\.js/ nocase ascii wide
                        $string15_beef_offensive_tool_keyword = /\/man_in_the_browser\/.{0,1000}\.rb/ nocase ascii wide
                        ...
                        $string19_beef_offensive_tool_keyword = /_dns_hijack\/.{0,1000}\.js/ nocase ascii wide
                        $string20_beef_offensive_tool_keyword = /_dns_hijack\/.{0,1000}\.rb/ nocase ascii wide
                        ...
                        $string26_beef_offensive_tool_keyword = /beef_bind\-stage.{0,1000}\.rb/ nocase ascii wide
                        ...
                        $string42_beef_offensive_tool_keyword = /exploit.{0,1000}wordpress_add_admin/ nocase ascii wide
                        $string43_beef_offensive_tool_keyword = /exploits.{0,1000}_csrf\/.{0,1000}\.js/ nocase ascii wide
                        $string44_beef_offensive_tool_keyword = /exploits.{0,1000}_csrf\/.{0,1000}\.rb/ nocase ascii wide
                        $string45_beef_offensive_tool_keyword = /extract_cmd_exec.{0,1000}\.js/ nocase ascii wide
                        $string46_beef_offensive_tool_keyword = /extract_cmd_exec.{0,1000}\.rb/ nocase ascii wide
                        ...
                        $string57_beef_offensive_tool_keyword = /http.{0,1000}\/demos\/butcher\/index\.html/ nocase ascii wide
                        $string58_beef_offensive_tool_keyword = /http.{0,1000}\:3000\/hook\.js/ nocase ascii wide
                        ...
                        $string69_beef_offensive_tool_keyword = /modules\/exploits\/.{0,1000}\.js/ nocase ascii wide
                        $string70_beef_offensive_tool_keyword = /modules\/exploits\/.{0,1000}\.rb/ nocase ascii wide
                        $string71_beef_offensive_tool_keyword = /pfsense.{0,1000}reverse_root_shell_csrf\// nocase ascii wide
                        ...
                        $string75_beef_offensive_tool_keyword = /shell_shocked.{0,1000}\.js/ nocase ascii wide
                        $string76_beef_offensive_tool_keyword = /shell_shocked.{0,1000}\.rb/ nocase ascii wide
