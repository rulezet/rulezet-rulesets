rule rule_wiretap_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string19_wiretap_greyware_tool_keyword = /\/wiretap_.{0,1000}_linux_386\.tar\.gz/
                        $string20_wiretap_greyware_tool_keyword = /\/wiretap_.{0,1000}_linux_amd64\.tar\.gz/
                        $string21_wiretap_greyware_tool_keyword = /\/wiretap_.{0,1000}_linux_arm64\.tar\.gz/
                        $string22_wiretap_greyware_tool_keyword = /\/wiretap_.{0,1000}_linux_armv6\.tar\.gz/
