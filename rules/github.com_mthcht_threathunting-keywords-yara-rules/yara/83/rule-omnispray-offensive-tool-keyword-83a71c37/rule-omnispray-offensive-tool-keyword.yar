rule rule_Omnispray_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string15_Omnispray_offensive_tool_keyword = /\s\-\-type\senum\s\-uf\s.{0,1000}\s\-\-module\so365_enum_office/ nocase ascii wide
                        $string16_Omnispray_offensive_tool_keyword = /\s\-\-type\sspray\s\-uf\s.{0,1000}\s\-pf\s/ nocase ascii wide
