rule rule_shadowsocks_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string10_shadowsocks_greyware_tool_keyword = /\/Shadowsocks\-.{0,100}\.zip/ nocase ascii wide
                        ...
                        $string24_shadowsocks_greyware_tool_keyword = /\\Shadowsocks\-.{0,100}\.zip/ nocase ascii wide
