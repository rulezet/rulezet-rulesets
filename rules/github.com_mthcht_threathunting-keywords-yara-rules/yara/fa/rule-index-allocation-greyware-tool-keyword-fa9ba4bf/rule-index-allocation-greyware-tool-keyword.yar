rule rule_index_allocation_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string2_index_allocation_greyware_tool_keyword = /cd\s.{0,100}\.\:\:\$index_allocation/ nocase ascii wide
                        $string3_index_allocation_greyware_tool_keyword = /md\s.{0,100}\.\:\:\$index_allocation/ nocase ascii wide
