rule rule_megatools_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_megatools_greyware_tool_keyword = /\\megatools\-.{0,100}\-win64\\/ nocase ascii wide
                        $string4_megatools_greyware_tool_keyword = /\\megatools\.exe/ nocase ascii wide
                        $string5_megatools_greyware_tool_keyword = /\\Users\\.{0,100}\\AppData\\Local\\Temp\\.{0,100}\.megatools\.cache/ nocase ascii wide
                        $string6_megatools_greyware_tool_keyword = /megatools\scopy\s\-l\s.{0,100}\s\-r\s/ nocase ascii wide
