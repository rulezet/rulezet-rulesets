rule rule_wmic_greyware_tool_keyword
{
    ...
    strings:
                        $string1_wmic_greyware_tool_keyword = /\sprocess\scall\screate\s.{0,100}cmd\.exe\s\/c\spowershell\.exe\s\-nop\s\-w\shidden\s\-c\s.{0,100}IEX\s\(\(new\-object\snet\.webclient\)\.downloadstring\(\'https\:\/\// nocase ascii wide
                        ...
                        $string4_wmic_greyware_tool_keyword = /\\Temp\\.{0,100}\\ntds\.dit/ nocase ascii wide
                        $string5_wmic_greyware_tool_keyword = /\\Temp\\.{0,100}\\ntds\.jfm/ nocase ascii wide
                        $string6_wmic_greyware_tool_keyword = /\\Users\\Public\\.{0,100}ntds\.dit/ nocase ascii wide
                        $string7_wmic_greyware_tool_keyword = /\\Users\\Public\\.{0,100}ntds\.jfm/ nocase ascii wide
                        $string8_wmic_greyware_tool_keyword = /ac\si\sntds.{0,100}\\\\127\.0\.0\.1\\ADMIN\$\\/ nocase ascii wide
                        $string9_wmic_greyware_tool_keyword = /cmd\s\s\/c\swmic\s\/node\:.{0,100}\sprocess\scall\screate\s\\"C\:\\programdata\\/ nocase ascii wide
                        $string10_wmic_greyware_tool_keyword = /cmd\s\s\/c\swmic\s\/node\:.{0,100}\sprocess\scall\screate\s\\"C\:\\Temp\\/ nocase ascii wide
                        $string11_wmic_greyware_tool_keyword = /cmd\s\s\/c\swmic\s\/node\:.{0,100}\sprocess\scall\screate\s\\"C\:\\users\\.{0,100}\\AppData\\Local\\Temp/ nocase ascii wide
                        $string12_wmic_greyware_tool_keyword = /cmd\s\s\/c\swmic\s\/node\:.{0,100}\sprocess\scall\screate\s\\"C\:\\users\\Public/ nocase ascii wide
                        $string13_wmic_greyware_tool_keyword = /cmd\.exe\s\/C\swmic\s\/node\:.{0,100}\s\/user\:.{0,100}\s\/password\:.{0,100}\sos\sget\scaption/ nocase ascii wide
                        $string14_wmic_greyware_tool_keyword = "process call create \"powershell enable-psremoting -force\"" nocase ascii wide
                        $string15_wmic_greyware_tool_keyword = /start\swmic\s\/node\:\@C\:\\.{0,100}\.txt\s\/user\:.{0,100}\/password\:.{0,100}\sprocess\scall\screate\s.{0,100}cmd\.exe\s\/c\sbitsadmin\s\/transfer\s.{0,100}\.exe\s/ nocase ascii wide
                        $string16_wmic_greyware_tool_keyword = /Win32_Shadowcopy\s\|\sForEach\-Object\s\{\$_\.Delete\(\)\;/ nocase ascii wide
                        $string17_wmic_greyware_tool_keyword = /wmic\s\/.{0,100}\s\/user\:administrator\sprocess\scall\screate\s.{0,100}cmd\.exe\s\/c\s/ nocase ascii wide
                        $string18_wmic_greyware_tool_keyword = /wmic\s\/node\:.{0,100}\s\/user\:.{0,100}\s\/password\:.{0,100}\sprocess\scall\screate\s\\"\\\\.{0,100}\\.{0,100}\.exe/ nocase ascii wide
                        $string19_wmic_greyware_tool_keyword = /wmic\s\/node\:.{0,100}\spath\sWin32_TerminalServiceSetting\swhere\sAllowTSConnections\=\\"0\\"\scall\sSetAllowTSConnections\s\\"1\\"/ nocase ascii wide
                        $string20_wmic_greyware_tool_keyword = /wmic\s\/node\:.{0,100}\..{0,100}\..{0,100}\..{0,100}computersystem\sget\susername/ nocase ascii wide
                        $string21_wmic_greyware_tool_keyword = /wmic\s\/node\:.{0,100}localhost.{0,100}computersystem\sget\susername/ nocase ascii wide
                        ...
                        $string24_wmic_greyware_tool_keyword = /wmic\sprocess\scall\screate.{0,100}ntdsutil\s.{0,100}ac\si\sntds.{0,100}\sifm.{0,100}create\sfull/ nocase ascii wide
                        ...
                        $string53_wmic_greyware_tool_keyword = /wmic.{0,100}\/Namespace\:\\\\root\\SecurityCenter2\sPath\sAntiVirusProduct\sGet\sdisplayName/ nocase ascii wide
                        $string54_wmic_greyware_tool_keyword = /wmic\.exe\sprocess\scall\screate\s.{0,100}\.txt\:.{0,100}\.exe/ nocase ascii wide
                        $string55_wmic_greyware_tool_keyword = /wmic\.exe\sprocess\scall\screate\s.{0,100}cmd\s\/c\s/ nocase ascii wide
                        ...
                        $string58_wmic_greyware_tool_keyword = /WMIC\.exe\sshadowcopy\swhere\s.{0,100}ID\=.{0,100}\sdelete/ nocase ascii wide
