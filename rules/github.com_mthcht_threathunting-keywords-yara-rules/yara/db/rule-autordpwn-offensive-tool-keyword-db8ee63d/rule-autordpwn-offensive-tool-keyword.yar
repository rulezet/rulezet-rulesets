rule rule_AutoRDPwn_offensive_tool_keyword
{
    ...
    strings:
                        $string1_AutoRDPwn_offensive_tool_keyword = /\s\-Reverse\s\-IPAddress\s.{0,1000}\s\-Port\s/ nocase ascii wide
                        $string2_AutoRDPwn_offensive_tool_keyword = /\s\-TaskName\s.{0,1000}AutoRDPwn/ nocase ascii wide
                        ...
                        $string76_AutoRDPwn_offensive_tool_keyword = /net\slocalgroup\s.{0,1000}\sAutoRDPwn\s\/add/ nocase ascii wide
