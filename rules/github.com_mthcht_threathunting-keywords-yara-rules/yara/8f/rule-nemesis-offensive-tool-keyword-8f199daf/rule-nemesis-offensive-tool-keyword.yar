rule rule_nemesis_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string35_nemesis_offensive_tool_keyword = /\.\/agscript\s.{0,1000}\snemesis\-bot\s/
                        ...
                        $string96_nemesis_offensive_tool_keyword = /https\:\/\/nemesis\..{0,1000}\.com\/api\// nocase ascii wide
