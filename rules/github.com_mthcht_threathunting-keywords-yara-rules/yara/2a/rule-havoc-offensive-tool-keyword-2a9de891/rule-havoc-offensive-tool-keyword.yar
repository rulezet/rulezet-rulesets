rule rule_havoc_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_havoc_offensive_tool_keyword = /\.\/donut\s.{0,1000}\.exe/
                        ...
                        $string20_havoc_offensive_tool_keyword = /\/implants\/.{0,1000}\/Syscalls\./ nocase ascii wide
                        ...
                        $string29_havoc_offensive_tool_keyword = /\/Talon\/.{0,1000}Agent\/Source/ nocase ascii wide
                        ...
                        $string73_havoc_offensive_tool_keyword = /http.{0,1000}\/demon\.dll/ nocase ascii wide
                        $string74_havoc_offensive_tool_keyword = /http.{0,1000}\/demon\.exe/ nocase ascii wide
