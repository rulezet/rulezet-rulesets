rule rule_Portr_greyware_tool_keyword
{
    ...
    strings:
                        $string1_Portr_greyware_tool_keyword = " on http://localhost:7777" nocase ascii wide
                        $string2_Portr_greyware_tool_keyword = " Portr inspector running on " nocase ascii wide
                        ...
                        $string5_Portr_greyware_tool_keyword = "/bin/portr"
                        ...
                        $string9_Portr_greyware_tool_keyword = /\/portr_.{0,100}_Darwin_arm64\.zip/
                        $string10_Portr_greyware_tool_keyword = /\/portr_.{0,100}_Darwin_x86_64\.zip/
                        $string11_Portr_greyware_tool_keyword = /\/portr_.{0,100}_Linux_arm64\.zip/
                        $string12_Portr_greyware_tool_keyword = /\/portr_.{0,100}_Linux_x86_64\.zip/
                        $string13_Portr_greyware_tool_keyword = /\/portr_.{0,100}_Windows_arm64\.zip/ nocase ascii wide
                        $string14_Portr_greyware_tool_keyword = /\/portr_.{0,100}_Windows_x86_64\.zip/ nocase ascii wide
                        $string15_Portr_greyware_tool_keyword = /\/portr_admin\/.{0,100}\.py/ nocase ascii wide
                        ...
                        $string73_Portr_greyware_tool_keyword = "Portr - Expose local ports to public URLs" nocase ascii wide
                        $string74_Portr_greyware_tool_keyword = "portr auth set --token " nocase ascii wide
                        $string75_Portr_greyware_tool_keyword = /portr\s\-c\s.{0,100}\.yaml/ nocase ascii wide
                        $string76_Portr_greyware_tool_keyword = "portr http " nocase ascii wide
                        $string77_Portr_greyware_tool_keyword = "portr tcp " nocase ascii wide
