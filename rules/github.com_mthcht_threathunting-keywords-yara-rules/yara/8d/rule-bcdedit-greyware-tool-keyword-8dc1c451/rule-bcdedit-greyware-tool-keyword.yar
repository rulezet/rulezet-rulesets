rule rule_bcdedit_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string4_bcdedit_greyware_tool_keyword = /bcdedit.{0,100}\s\/set\s\{default\}\sbootstatuspolicy\signoreallfailures/ nocase ascii wide
                        $string5_bcdedit_greyware_tool_keyword = /bcdedit.{0,100}\s\/set\s\{default\}\srecoveryenabled\sNo/ nocase ascii wide
