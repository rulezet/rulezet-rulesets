rule rule_LaZagne_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string4_LaZagne_offensive_tool_keyword = /\/creddump7.{0,1000}\.py/ nocase ascii wide
                        ...
                        $string46_LaZagne_offensive_tool_keyword = /memory.{0,1000}mimipy\.py/ nocase ascii wide
                        ...
                        $string50_LaZagne_offensive_tool_keyword = /windows.{0,1000}lsa_secrets\.py/ nocase ascii wide
