rule rule_AVDump_greyware_tool_keyword
{
    ...
    strings:
                        $string1_AVDump_greyware_tool_keyword = /\\AvDump\.exe\s\-\-pid\s.{0,100}\s\-\-exception_ptr\s0/ nocase ascii wide
                        $string2_AVDump_greyware_tool_keyword = /AvDump\.exe\s\-\-pid\s.{0,100}\s\-\-dump_file\s.{0,100}\.dmp/ nocase ascii wide
