rule rule_Slackor_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string5_Slackor_offensive_tool_keyword = /\sgoldenPac\.py\s\-c\s.{0,1000}\.exe/ nocase ascii wide
                        ...
                        $string42_Slackor_offensive_tool_keyword = /appdata.{0,1000}\\Windows\:svchost\.exe/ nocase ascii wide
                        $string43_Slackor_offensive_tool_keyword = /appdata.{0,1000}\\Windows\:winrm\.vbs/ nocase ascii wide
                        ...
                        $string48_Slackor_offensive_tool_keyword = /C\:\\Users\\Public\\.{0,1000}\.dmp/ nocase ascii wide
                        ...
                        $string84_Slackor_offensive_tool_keyword = /powershell\s.{0,1000}C\:\\Users\\Public\\.{0,1000}\.exe.{0,1000}\sforfiles\.exe\s\/p\s.{0,1000}\\system32\s.{0,1000}\.exe/ nocase ascii wide
