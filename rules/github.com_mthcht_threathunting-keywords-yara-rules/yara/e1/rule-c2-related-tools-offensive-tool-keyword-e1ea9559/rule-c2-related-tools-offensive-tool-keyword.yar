rule rule_C2_related_tools_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_C2_related_tools_offensive_tool_keyword = /\s\-pe\-exp\-list\s.{0,1000}\.dll/ nocase ascii wide
                        ...
                        $string6_C2_related_tools_offensive_tool_keyword = /\!wPkgPath\!.{0,1000}\!ak\!/ nocase ascii wide
                        ...
                        $string29_C2_related_tools_offensive_tool_keyword = /cool.{0,1000}\/cool\.zip/ nocase ascii wide
                        $string30_C2_related_tools_offensive_tool_keyword = /coolv0\.1\.exe/ nocase ascii wide
                        $string31_C2_related_tools_offensive_tool_keyword = /Cooolis.{0,1000}shellcode/ nocase ascii wide
                        ...
                        $string45_C2_related_tools_offensive_tool_keyword = /execute\-assembly.{0,1000}sigflip/ nocase ascii wide
                        ...
                        $string65_C2_related_tools_offensive_tool_keyword = /NoPowerShell\/.{0,1000}\.cs/ nocase ascii wide
                        ...
                        $string79_C2_related_tools_offensive_tool_keyword = /sigflip.{0,1000}\/Bof\// nocase ascii wide
