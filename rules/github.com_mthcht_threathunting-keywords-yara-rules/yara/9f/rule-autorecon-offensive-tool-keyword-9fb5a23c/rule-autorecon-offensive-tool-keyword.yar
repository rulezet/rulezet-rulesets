rule rule_AutoRecon_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string91_AutoRecon_offensive_tool_keyword = /import.{0,1000}autorecon\.config/ nocase ascii wide
                        $string92_AutoRecon_offensive_tool_keyword = /import.{0,1000}autorecon\.plugins/ nocase ascii wide
