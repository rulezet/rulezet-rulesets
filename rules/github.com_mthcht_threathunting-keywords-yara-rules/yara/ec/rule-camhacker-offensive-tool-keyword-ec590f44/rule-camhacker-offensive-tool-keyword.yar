rule rule_CamHacker_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_CamHacker_offensive_tool_keyword = /\stermux\-chroot\s.{0,1000}\/cloudflared/ nocase ascii wide
                        ...
                        $string13_CamHacker_offensive_tool_keyword = /\/CamHacker\-.{0,1000}\.png/ nocase ascii wide
