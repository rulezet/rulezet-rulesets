rule rule_netcat_greyware_tool_keyword
{
    ...
    strings:
                        $string1_netcat_greyware_tool_keyword = /\/netcat\-win32\-.{0,100}\.zip/
                        ...
                        $string4_netcat_greyware_tool_keyword = /nc\s.{0,100}\s\-e\s\/bin\/bash/
                        $string5_netcat_greyware_tool_keyword = "nc -u -lvp " nocase ascii wide
                        $string6_netcat_greyware_tool_keyword = /ncat\s.{0,100}\s\-e\s\/bin\/bash/
                        $string7_netcat_greyware_tool_keyword = /ncat\s\-\-udp\s.{0,100}\s\-e\s\/bin\/bash/
