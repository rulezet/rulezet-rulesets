rule rule_xcopy_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string2_xcopy_greyware_tool_keyword = /xcopy\s\/Y\s\/C\s\/Q\sC\:\\Windows\\system32\\.{0,100}\.exe\s.{0,100}Ie4uinit\.exe/ nocase ascii wide
                        $string3_xcopy_greyware_tool_keyword = /xcopy\sc\:\\.{0,100}\s\\\\.{0,100}\\c\$/ nocase ascii wide
