rule rule_Egress_Assess_offensive_tool_keyword
{
    ...
    strings:
                        $string1_Egress_Assess_offensive_tool_keyword = /\s\-client\sftp\s\-ip\s.{0,1000}\s\-Username\s.{0,1000}\s\-Password\s.{0,1000}\s\-Datatype\sssn\s\-Size\s.{0,1000}\s\-Verbose/ nocase ascii wide
                        $string2_Egress_Assess_offensive_tool_keyword = /\s\-client\shttp\s\-ip\s.{0,1000}\s\-Datatype\scc\s\-Size\s.{0,1000}\s\-Port\s.{0,1000}\s\-Loop\s.{0,1000}\s\-Fast\s\-Verbose/ nocase ascii wide
                        $string3_Egress_Assess_offensive_tool_keyword = /\s\-client\sicmp\s\-ip\s.{0,1000}\s\-Datatype\sssn\s\-Report\s\-Verbose/ nocase ascii wide
                        $string4_Egress_Assess_offensive_tool_keyword = /\s\-client\ssmb\s\-ip\s.{0,1000}\s\-Datatype\s.{0,1000}c\:\\.{0,1000}\..{0,1000}\s\-Verbose/ nocase ascii wide
                        $string5_Egress_Assess_offensive_tool_keyword = /\s\-Client\sSMTPOutlook\s\-IP\s.{0,1000}\s\-NoPing\s\-DataType\s.{0,1000}ssn/ nocase ascii wide
                        ...
                        $string10_Egress_Assess_offensive_tool_keyword = /\.py\s\-\-client\sftp\s\-\-username\s.{0,1000}\s\-\-password\s.{0,1000}\s\-\-ip\s.{0,1000}\s\-\-datatype\sssn/ nocase ascii wide
                        $string11_Egress_Assess_offensive_tool_keyword = /\.py\s\-\-client\shttps\s\-\-data\-size\s.{0,1000}\s\-\-ip\s.{0,1000}\s\-\-datatype\scc/ nocase ascii wide
                        ...
                        $string18_Egress_Assess_offensive_tool_keyword = /\/commandcontrol\/malware.{0,1000}\.py/ nocase ascii wide
                        ...
                        $string38_Egress_Assess_offensive_tool_keyword = /b64encode.{0,1000}\.\:\:\:\-989\-\:\:\:\./ nocase ascii wide
                        ...
                        $string44_Egress_Assess_offensive_tool_keyword = /Copy\-Item\s\-Path\s.{0,1000}\s\-Destination\s\\\\\$IP\\transfer/ nocase ascii wide
                        ...
                        $string76_Egress_Assess_offensive_tool_keyword = /smbclient\s\\\\\\\\\\\\\\\\.{0,1000}\\\\\\\\TRANSFER\s\-N\s\-p\s.{0,1000}\s\-c\s\\.{0,1000}put\s/ nocase ascii wide
