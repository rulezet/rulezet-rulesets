rule rule_SharpShooter_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_SharpShooter_offensive_tool_keyword = /\s\-\-dotnetver\s.{0,1000}\s\-\-payload\s.{0,1000}\s\-\-sandbox\s/ nocase ascii wide
                        $string4_SharpShooter_offensive_tool_keyword = /\s\-\-payload\s.{0,1000}\s\-\-output\s.{0,1000}\s\-\-rawscfile\s.{0,1000}\s\-\-smuggle\s/ nocase ascii wide
                        ...
                        $string7_SharpShooter_offensive_tool_keyword = /\s\-\-stageless\s\-\-dotnetver\s.{0,1000}\s\-\-payload\s/ nocase ascii wide
