rule rule_mediafire_greyware_tool_keyword
{
    ...
    strings:
                        $string1_mediafire_greyware_tool_keyword = /\/download.{0,100}mediafire\.com\// nocase ascii wide
                        $string2_mediafire_greyware_tool_keyword = /https\:\/\/www\.mediafire\.com\/api\/.{0,100}\/folder\/get_content\.php/ nocase ascii wide
                        ...
                        $string5_mediafire_greyware_tool_keyword = /www\.mediafire\.com\/file\/.{0,100}\.rar\/file/ nocase ascii wide
