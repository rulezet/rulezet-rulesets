rule rule_nimbo_c2_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string21_nimbo_c2_offensive_tool_keyword = /lsass_.{0,1000}\.dmp/ nocase ascii wide
                        $string22_nimbo_c2_offensive_tool_keyword = /memfd\simplant\s.{0,1000}\.elf/ nocase ascii wide
                        $string23_nimbo_c2_offensive_tool_keyword = /memfd\stask\s.{0,1000}\.elf/ nocase ascii wide
                        ...
                        $string31_nimbo_c2_offensive_tool_keyword = /persist\srun\s.{0,1000}hkcu/ nocase ascii wide
                        $string32_nimbo_c2_offensive_tool_keyword = /persist\srun\s.{0,1000}hklm/ nocase ascii wide
                        $string33_nimbo_c2_offensive_tool_keyword = /persist\sspe\s.{0,1000}\.exe/ nocase ascii wide
                        ...
                        $string40_nimbo_c2_offensive_tool_keyword = /shellc\s.{0,1000}\.bin\s/ nocase ascii wide
                        $string41_nimbo_c2_offensive_tool_keyword = /shellc\s.{0,1000}\.shellc\s/ nocase ascii wide
