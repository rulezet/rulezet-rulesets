rule rule_AutoHotkey_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string4_AutoHotkey_greyware_tool_keyword = /\/AutoHotkey_.{0,100}\.zip/ nocase ascii wide
                        ...
                        $string8_AutoHotkey_greyware_tool_keyword = /\\AutoHotkey_.{0,100}\.zip/ nocase ascii wide
