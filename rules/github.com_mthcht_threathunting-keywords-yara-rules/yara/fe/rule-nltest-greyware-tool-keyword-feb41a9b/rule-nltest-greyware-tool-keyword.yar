rule rule_nltest_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string5_nltest_greyware_tool_keyword = /nltest\s\/dsgetdc\:.{0,100}\s\/force/ nocase ascii wide
                        $string6_nltest_greyware_tool_keyword = /nltest\s\/dsgetdc\:.{0,100}\s\/force/ nocase ascii wide
                        ...
                        $string9_nltest_greyware_tool_keyword = /nltest\s\/server\:.{0,100}\s\/domain_trusts/ nocase ascii wide
                        $string10_nltest_greyware_tool_keyword = /nltest\s\/server\:.{0,100}\s\/trusted_domains\s\/v/ nocase ascii wide
                        $string11_nltest_greyware_tool_keyword = "nltest -dsgetdc" nocase ascii wide
                        $string12_nltest_greyware_tool_keyword = /nltest.{0,100}\/dclist\:/ nocase ascii wide
