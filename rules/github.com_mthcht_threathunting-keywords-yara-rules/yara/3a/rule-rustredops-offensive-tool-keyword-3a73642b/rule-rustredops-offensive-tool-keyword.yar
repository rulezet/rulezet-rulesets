rule rule_RustRedOps_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string25_RustRedOps_offensive_tool_keyword = /\s\-p\swindows\/x64\/exec\sCMD\=.{0,1000}\.exe\s\-f\srust/ nocase ascii wide
                        ...
                        $string121_RustRedOps_offensive_tool_keyword = /obfuscation\.exe\s\-f\s.{0,1000}\s\-t\s/ nocase ascii wide
