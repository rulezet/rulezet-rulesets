rule rule_Nidhogg_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string21_Nidhogg_offensive_tool_keyword = /include\s.{0,1000}Nidhogg\.hpp/ nocase ascii wide
                        $string22_Nidhogg_offensive_tool_keyword = "Nidhogg rootkit" nocase ascii wide
                        $string23_Nidhogg_offensive_tool_keyword = /Nidhogg.{0,1000}AntiAnalysis\.hpp/ nocase ascii wide
