rule rule_SentinelAgent_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string6_SentinelAgent_greyware_tool_keyword = /DumpProcessPid\s\-targetPID\s.{0,100}\s\-outputFile/ nocase ascii wide
                        $string7_SentinelAgent_greyware_tool_keyword = /TakeDump\s\-SentinelHelper\s.{0,100}\s\-ProcessId\s.{0,100}\s\-User\s.{0,100}\s\-Kernel\s/ nocase ascii wide
