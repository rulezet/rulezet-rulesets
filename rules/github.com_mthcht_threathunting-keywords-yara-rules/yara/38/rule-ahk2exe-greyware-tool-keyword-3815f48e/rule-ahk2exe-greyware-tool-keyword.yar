rule rule_Ahk2Exe_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string5_Ahk2Exe_greyware_tool_keyword = /\/Ahk2Exe1\..{0,100}\.zip/ nocase ascii wide
                        ...
                        $string8_Ahk2Exe_greyware_tool_keyword = /\/AutoHotkey_1.{0,100}_setup\.exe/ nocase ascii wide
                        $string9_Ahk2Exe_greyware_tool_keyword = /\/AutoHotkey_2.{0,100}_setup\.exe/ nocase ascii wide
                        ...
                        $string15_Ahk2Exe_greyware_tool_keyword = /\\AutoHotkey_1.{0,100}_setup\.exe/ nocase ascii wide
                        $string16_Ahk2Exe_greyware_tool_keyword = /\\AutoHotkey_2.{0,100}_setup\.exe/ nocase ascii wide
