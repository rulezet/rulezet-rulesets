rule rule_Luna_Grabber_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string4_Luna_Grabber_offensive_tool_keyword = /\.\/Obfuscated_.{0,1000}\.py/
                        ...
                        $string18_Luna_Grabber_offensive_tool_keyword = /\\Luna\-Logged\-.{0,1000}\.zip/ nocase ascii wide
                        ...
                        $string40_Luna_Grabber_offensive_tool_keyword = /Successfully\sobfuscated\sfile\:\s.{0,1000}\.py/ nocase ascii wide
