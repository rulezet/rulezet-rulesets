rule rule_fiddler_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string2_fiddler_greyware_tool_keyword = /\/Fiddler\sEverywhere\s.{0,100}\..{0,100}\..{0,100}\.exe/ nocase ascii wide
                        $string3_fiddler_greyware_tool_keyword = /\\Fiddler\sEverywhere\s.{0,100}\..{0,100}\..{0,100}\.exe/ nocase ascii wide
