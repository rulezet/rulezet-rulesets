rule rule_Portr_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string9_Portr_greyware_tool_keyword = /\/portr_.{0,1000}_Darwin_arm64\.zip/
                        $string10_Portr_greyware_tool_keyword = /\/portr_.{0,1000}_Darwin_x86_64\.zip/
                        $string11_Portr_greyware_tool_keyword = /\/portr_.{0,1000}_Linux_arm64\.zip/
                        $string12_Portr_greyware_tool_keyword = /\/portr_.{0,1000}_Linux_x86_64\.zip/
