rule rule_RemotePotato0_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string4_RemotePotato0_offensive_tool_keyword = /\s\-s\s127\.0\.0\.1\s\-e\s.{0,1000}\s\-a\sconnect\s\-u\sntlm/ nocase ascii wide
                        $string5_RemotePotato0_offensive_tool_keyword = /\#include\s\\"RogueOxidResolver\.h/ nocase ascii wide
                        $string6_RemotePotato0_offensive_tool_keyword = /\.py\s\-t\sldap\:\/\/.{0,1000}\s\-\-no\-wcf\-server\s\-\-escalate\-user\s/ nocase ascii wide
                        ...
                        $string28_RemotePotato0_offensive_tool_keyword = /RemotePotato0.{0,1000}\@splinter_code\s\&\s\@decoder_it/ nocase ascii wide
                        ...
                        $string31_RemotePotato0_offensive_tool_keyword = /sudo\ssocat\s\-v\sTCP\-LISTEN\:135.{0,1000}rogueOxidResolverPort/
