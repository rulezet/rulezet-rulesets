rule rule_RunasCs_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_RunasCs_offensive_tool_keyword = /\s\-Username\s.{0,1000}\s\-Password\s.{0,1000}\s\-Command\s.{0,1000}\s\-LogonType\s/ nocase ascii wide
                        ...
                        $string37_RunasCs_offensive_tool_keyword = /\-\-bypass\-uac.{0,1000}\-\-logontype/ nocase ascii wide
                        ...
                        $string39_RunasCs_offensive_tool_keyword = /cmd\s\/c\s.{0,1000}\s\-\-bypass\-uac/ nocase ascii wide
                        $string40_RunasCs_offensive_tool_keyword = /cmd\s\/c\s.{0,1000}\s\-\-remote\-impersonation/ nocase ascii wide
                        ...
                        $string52_RunasCs_offensive_tool_keyword = /RunasCs.{0,1000}\s\-\-remote\-impersonation/ nocase ascii wide
