rule rule_sish_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string8_sish_greyware_tool_keyword = /http\:\/\/.{0,100}\.ssi\.sh/ nocase ascii wide
                        $string9_sish_greyware_tool_keyword = /https\:\/\/.{0,100}\.ssi\.sh/ nocase ascii wide
                        $string10_sish_greyware_tool_keyword = "sish -x" nocase ascii wide
                        $string11_sish_greyware_tool_keyword = /ssh\s\-L\s.{0,100}\stuns\.sh/ nocase ascii wide
                        $string12_sish_greyware_tool_keyword = /ssh\s\-R\s.{0,100}\stuns\.sh/ nocase ascii wide
