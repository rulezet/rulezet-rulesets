rule rule_SharpToken_offensive_tool_keyword
{
    ...
    strings:
                        $string1_SharpToken_offensive_tool_keyword = /\sexecute\s.{0,1000}NT\sAUTHORITY\\SYSTEM.{0,1000}cmd\s\/c\s/ nocase ascii wide
                        $string2_SharpToken_offensive_tool_keyword = /\sexecute\sNT\sAUTHORITY\\SYSTEM.{0,1000}\scmd\strue\sbypass/ nocase ascii wide
                        ...
                        $string15_SharpToken_offensive_tool_keyword = /cmd\s\/c\swhoami.{0,1000}\sbypass/ nocase ascii wide
                        ...
                        $string20_SharpToken_offensive_tool_keyword = /SharpToken.{0,1000}\sadd_user/ nocase ascii wide
                        $string21_SharpToken_offensive_tool_keyword = /SharpToken.{0,1000}\sdelete_user/ nocase ascii wide
                        $string22_SharpToken_offensive_tool_keyword = /SharpToken.{0,1000}\senableUser\s/ nocase ascii wide
                        $string23_SharpToken_offensive_tool_keyword = /SharpToken.{0,1000}\slist_token/ nocase ascii wide
                        $string24_SharpToken_offensive_tool_keyword = /SharpToken.{0,1000}\stscon\s/ nocase ascii wide
