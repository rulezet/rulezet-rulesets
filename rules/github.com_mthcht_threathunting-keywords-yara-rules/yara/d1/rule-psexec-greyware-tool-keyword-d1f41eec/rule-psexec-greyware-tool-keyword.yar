rule rule_psexec_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string20_psexec_greyware_tool_keyword = /\\Windows\\PSEXEC\-.{0,100}\.key/ nocase ascii wide
                        $string21_psexec_greyware_tool_keyword = /PSEXEC\-.{0,100}\.key/ nocase ascii wide
                        ...
                        $string26_psexec_greyware_tool_keyword = /PSEXECSVC\.EXE\-.{0,100}\.pf/ nocase ascii wide
