rule rule_tmpwatch_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_tmpwatch_greyware_tool_keyword = /echo\s.{0,100}bailing\.\stry\sa\sdifferent\sname\\/ nocase ascii wide
                        $string4_tmpwatch_greyware_tool_keyword = /if\s\[\s\-f\s\/tmp\/tmpwatch\s\]\s.{0,100}\sthen/ nocase ascii wide
