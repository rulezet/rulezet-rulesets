rule rule_tunnel_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string4_tunnel_greyware_tool_keyword = /\/etc\/wireguard\/.{0,100}\.conf/
                        $string5_tunnel_greyware_tool_keyword = /\/etc\/wireguard\/.{0,100}\.conf/
                        ...
                        $string16_tunnel_greyware_tool_keyword = /github.{0,100}koding\/tunnel/ nocase ascii wide
