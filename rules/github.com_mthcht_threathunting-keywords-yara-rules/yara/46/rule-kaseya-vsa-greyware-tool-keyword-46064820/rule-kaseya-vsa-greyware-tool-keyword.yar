rule rule_kaseya_VSA_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string36_kaseya_VSA_greyware_tool_keyword = /PCMONITORMANAGER\.EXE\-.{0,100}\.pf/ nocase ascii wide
                        ...
                        $string39_kaseya_VSA_greyware_tool_keyword = /PCMONITORSRV\.EXE\-.{0,100}\.pf/ nocase ascii wide
                        ...
                        $string43_kaseya_VSA_greyware_tool_keyword = /PCMONTASK\.EXE\-.{0,100}\.pf/ nocase ascii wide
