rule rule_NetshRun_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string2_NetshRun_greyware_tool_keyword = /netsh\.exe\sadd\shelper\s.{0,100}\\temp\\.{0,100}\.dll/ nocase ascii wide
                        $string3_NetshRun_greyware_tool_keyword = /netshrun\.dll/ nocase ascii wide
                        $string4_NetshRun_greyware_tool_keyword = /PSBits.{0,100}NetShRun/ nocase ascii wide
