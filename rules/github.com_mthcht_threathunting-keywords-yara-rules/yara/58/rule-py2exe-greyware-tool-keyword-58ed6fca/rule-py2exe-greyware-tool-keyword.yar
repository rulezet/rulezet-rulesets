rule rule_py2exe_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string5_py2exe_greyware_tool_keyword = /py2exe.{0,100}\.exe\s/ nocase ascii wide
                        $string6_py2exe_greyware_tool_keyword = /py2exe.{0,100}\.msi\s/ nocase ascii wide
                        $string7_py2exe_greyware_tool_keyword = /py2exe.{0,100}\.py/ nocase ascii wide
                        $string8_py2exe_greyware_tool_keyword = /py2exe\-.{0,100}\.tar\.gz/ nocase ascii wide
                        $string9_py2exe_greyware_tool_keyword = /py2exe\-.{0,100}\.whl/ nocase ascii wide
