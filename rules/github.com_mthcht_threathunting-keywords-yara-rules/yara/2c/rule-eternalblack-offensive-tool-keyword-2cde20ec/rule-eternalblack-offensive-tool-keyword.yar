rule rule_EternalBlack_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string7_EternalBlack_offensive_tool_keyword = /\\eb\.exe.{0,1000}payload_x64\.dll/ nocase ascii wide
                        $string8_EternalBlack_offensive_tool_keyword = /\\eb\.exe.{0,1000}payload_x86\.dll/ nocase ascii wide
                        $string9_EternalBlack_offensive_tool_keyword = /\\eb\.exe.{0,1000}payload32\.exe/ nocase ascii wide
                        $string10_EternalBlack_offensive_tool_keyword = /\\eb\.exe.{0,1000}payload64\.exe/ nocase ascii wide
