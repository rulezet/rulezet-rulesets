rule rule_updog_greyware_tool_keyword
{
    ...
    strings:
                        $string1_updog_greyware_tool_keyword = /\/updog\-.{0,100}\.tar\.gz/ nocase ascii wide
                        ...
                        $string5_updog_greyware_tool_keyword = /pip.{0,100}\sinstall\supdog/ nocase ascii wide
