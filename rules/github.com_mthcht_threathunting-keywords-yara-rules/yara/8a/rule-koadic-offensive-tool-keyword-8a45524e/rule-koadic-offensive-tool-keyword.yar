rule rule_koadic_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string91_koadic_offensive_tool_keyword = /set\s.{0,1000}\svirus_scanner/ nocase ascii wide
                        ...
                        $string111_koadic_offensive_tool_keyword = /zerosum0x0.{0,1000}koadic/ nocase ascii wide
