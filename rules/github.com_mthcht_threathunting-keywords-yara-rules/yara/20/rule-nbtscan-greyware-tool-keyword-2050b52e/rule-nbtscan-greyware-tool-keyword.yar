rule rule_nbtscan_greyware_tool_keyword
{
    ...
    strings:
                        $string1_nbtscan_greyware_tool_keyword = /nbtscan\s.{0,100}\..{0,100}\/24/ nocase ascii wide
                        $string2_nbtscan_greyware_tool_keyword = /nbtscan\s\-r\s.{0,100}\/24/ nocase ascii wide
