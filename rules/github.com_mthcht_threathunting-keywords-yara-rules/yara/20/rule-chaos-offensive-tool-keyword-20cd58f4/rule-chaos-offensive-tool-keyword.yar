rule rule_chaos_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string18_chaos_offensive_tool_keyword = /C\:\\Users\\.{0,1000}\\AppData\\Roaming\\svchost\.exe/ nocase ascii wide
                        $string19_chaos_offensive_tool_keyword = /CHAOS\s\(Remote\sAdministration\sTool\)/ nocase ascii wide
                        $string20_chaos_offensive_tool_keyword = /chaos.{0,1000}persistence_enable/ nocase ascii wide
                        $string21_chaos_offensive_tool_keyword = /docker.{0,1000}\/chaos\-container\:\/temp\// nocase ascii wide
