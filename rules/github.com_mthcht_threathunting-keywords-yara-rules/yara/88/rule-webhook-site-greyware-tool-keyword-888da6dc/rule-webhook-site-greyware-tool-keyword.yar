rule rule_webhook_site_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_webhook_site_greyware_tool_keyword = /https\:\/\/webhook\.site\/.{0,100}\-.{0,100}\-.{0,100}\-/ nocase ascii wide
                        $string4_webhook_site_greyware_tool_keyword = /webhooksite\/webhook\.site/ nocase ascii wide
                        $string5_webhook_site_greyware_tool_keyword = /whcli\sforward\s\-\-token\=.{0,100}\-.{0,100}\-.{0,100}\s\-\-target\=https\:\/\/localhost/
