rule rule_Payload_Download_Cradles_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string7_Payload_Download_Cradles_offensive_tool_keyword = /\s\-eXecUT\sbyPAss\s\-WINDo\s1\s\-nOpR\s\-coMm\s\\"\\"\&\s\(\(vARiaBlE\s\'.{0,1000}mdr.{0,1000}\'\)\.Name\[3\,11\,2\]\-JoiN\'\'\)/ nocase ascii wide
