rule rule_nanodump_offensive_tool_keyword
{
    ...
    strings:
                        $string1_nanodump_offensive_tool_keyword = /\s\-\-fork\s\-\-write\s.{0,1000}\.dmp/ nocase ascii wide
                        $string2_nanodump_offensive_tool_keyword = /\s\-\-load\-dll\s.{0,1000}ssp\.dll/ nocase ascii wide
                        ...
                        $string9_nanodump_offensive_tool_keyword = /\s\-\-werfault\s.{0,1000}\\temp\\/ nocase ascii wide
                        ...
                        $string53_nanodump_offensive_tool_keyword = /load_ssp\s.{0,1000}\.dll/ nocase ascii wide
                        $string54_nanodump_offensive_tool_keyword = /load_ssp\.x64\.exe\s.{0,1000}\.dll/ nocase ascii wide
                        ...
                        $string74_nanodump_offensive_tool_keyword = /ppl.{0,1000}\s\-\-elevate\-handle\s.{0,1000}\.dmp/ nocase ascii wide
                        ...
                        $string79_nanodump_offensive_tool_keyword = /restore_signature\.sh\s.{0,1000}\.dmp/
