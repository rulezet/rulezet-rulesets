rule rule_hypertunnel_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string2_hypertunnel_greyware_tool_keyword = /\/hypertunnel\-tcp\-relay.{0,100}\.tar\.gz/ nocase ascii wide
                        $string3_hypertunnel_greyware_tool_keyword = /\/hypertunnel\-tcp\-relay.{0,100}\.zip/ nocase ascii wide
