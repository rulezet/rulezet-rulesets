rule rule_MakeMeAdmin_offensive_tool_keyword
{
    ...
    strings:
                        $string1_MakeMeAdmin_offensive_tool_keyword = /\/MakeMeAdmin\s.{0,1000}\sx64\.msi/ nocase ascii wide
                        ...
                        $string4_MakeMeAdmin_offensive_tool_keyword = /\/MakeMeAdmin\/tree\/v.{0,1000}\/Installers/ nocase ascii wide
                        $string5_MakeMeAdmin_offensive_tool_keyword = "/MakeMeAdmin/zipball" nocase ascii wide
                        $string6_MakeMeAdmin_offensive_tool_keyword = /\\MakeMeAdmin\s.{0,1000}\sx64\sDebug\.msi/ nocase ascii wide
                        $string7_MakeMeAdmin_offensive_tool_keyword = /\\MakeMeAdmin\s.{0,1000}\sx64\.msi/ nocase ascii wide
                        ...
                        $string43_MakeMeAdmin_offensive_tool_keyword = /net\.pipe\:\/\/.{0,1000}\/MakeMeAdmin\/Service\\"/ nocase ascii wide
                        $string44_MakeMeAdmin_offensive_tool_keyword = /net\.tcp\:\/\/.{0,1000}\/MakeMeAdmin\/Service/ nocase ascii wide
