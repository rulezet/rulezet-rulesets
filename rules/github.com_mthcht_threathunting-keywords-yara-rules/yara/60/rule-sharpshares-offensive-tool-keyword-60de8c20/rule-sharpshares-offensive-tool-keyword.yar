rule rule_SharpShares_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string2_SharpShares_offensive_tool_keyword = /\(\&\(objectCategory\=computer\)\(\!\(userAccountControl\:1\.2\.840\.113556\.1\.4\.803\:\=2\)\)\(operatingSystem\=.{0,1000}server.{0,1000}\)\(\!\(userAccountControl\:1\.2\.840\.113556\.1\.4\.803\:\=8192\)\)\(\!\(userAccountControl\:1\.2\.840\.113556\.1\.4\.803\:\=67100867\)\)\)/ nocase ascii wide
                        ...
                        $string9_SharpShares_offensive_tool_keyword = /\[\+\]\sStarting\sshare\senumeration\sagainst\s.{0,1000}\shosts/ nocase ascii wide
                        ...
                        $string45_SharpShares_offensive_tool_keyword = /execute\-assembly\s.{0,1000}\.exe\s\/ldap\:all\s\/filter\:sysvol.{0,1000}netlogon.{0,1000}ipc\$.{0,1000}print\$/ nocase ascii wide
