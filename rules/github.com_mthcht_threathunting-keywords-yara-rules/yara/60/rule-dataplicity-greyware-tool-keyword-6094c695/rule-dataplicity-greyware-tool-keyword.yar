rule rule_Dataplicity_greyware_tool_keyword
{
    ...
    strings:
                        $string1_Dataplicity_greyware_tool_keyword = "/bin/dataplicity"
                        $string2_Dataplicity_greyware_tool_keyword = /\/dataplicity\.app/
                        $string3_Dataplicity_greyware_tool_keyword = /\/dataplicity\.conf/
                        $string4_Dataplicity_greyware_tool_keyword = /\/dataplicity\.log/
                        ...
                        $string7_Dataplicity_greyware_tool_keyword = "/etc/dataplicity"
                        $string8_Dataplicity_greyware_tool_keyword = "/opt/dataplicity/"
                        ...
                        $string89_Dataplicity_greyware_tool_keyword = "from lomond import WebSocket" nocase ascii wide
                        $string90_Dataplicity_greyware_tool_keyword = /https\:\/\/www\.dataplicity\.com\/.{0,100}\.py/ nocase ascii wide
                        ...
                        $string93_Dataplicity_greyware_tool_keyword = "USER_AGENT = 'Lomond/" nocase ascii wide
