rule rule_vncviewer_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_vncviewer_greyware_tool_keyword = /ProgramData\\JWrapper\-Remote\sAccess\\.{0,100}\.exe/ nocase ascii wide
                        $string4_vncviewer_greyware_tool_keyword = /RealVNC\.VNCViewer/ nocase ascii wide
                        $string5_vncviewer_greyware_tool_keyword = /vncviewer\s.{0,100}\..{0,100}\:5901/
