rule rule_RemoteUtilities_greyware_tool_keyword
{
    ...
    strings:
                        $string1_RemoteUtilities_greyware_tool_keyword = /\sConnection\s\#.{0,100}\.\sConnection\sto\s\\".{0,100}\\"\sestablished\.\sMode\:\s\<Remote\scontrol\>\./ nocase ascii wide
                        $string2_RemoteUtilities_greyware_tool_keyword = /\sConnection\s\#.{0,100}\.\sConnection\sto\s\\".{0,100}\\"\.\sSecurity\scheck\s\-\sOK\.\sMode\:\s\s\<Inventory\smanager\>/ nocase ascii wide
                        $string3_RemoteUtilities_greyware_tool_keyword = /\sConnection\s\#.{0,100}\.\sConnection\sto\s\\".{0,100}\\"\.\sSecurity\scheck\s\-\sOK\.\sMode\:\s\<Command\s\(command\:\s.{0,100}\)\>/ nocase ascii wide
                        $string4_RemoteUtilities_greyware_tool_keyword = /\sConnection\s\#.{0,100}\.\sDirect\sconnection\sto\s.{0,100}\s\(.{0,100}\:5650\)\./ nocase ascii wide
                        $string5_RemoteUtilities_greyware_tool_keyword = /\s\-name\:.{0,100}\s\-password\:.{0,100}\s\-remoteexecute\s\-filename/ nocase ascii wide
                        ...
                        $string16_RemoteUtilities_greyware_tool_keyword = /\\.{0,100}\-.{0,100}\-.{0,100}_rut\-.{0,100}\.zip\.3bf/ nocase ascii wide
                        $string17_RemoteUtilities_greyware_tool_keyword = /\\.{0,100}\-internet\-id\-log\.csv/ nocase ascii wide
                        $string18_RemoteUtilities_greyware_tool_keyword = /\\AppData\\Local\\Downloaded\sInstallations\\.{0,100}\\server\-3\.3\.5\.0\.msi/ nocase ascii wide
                        $string19_RemoteUtilities_greyware_tool_keyword = /\\AppData\\Local\\Downloaded\sInstallations\\.{0,100}\\viewer\-7\.2\.2\.0\.msi/ nocase ascii wide
                        $string20_RemoteUtilities_greyware_tool_keyword = /\\AppData\\Local\\Temp\\.{0,100}\\server\-3\.3\.5\.0\.exe/ nocase ascii wide
                        $string21_RemoteUtilities_greyware_tool_keyword = /\\AppData\\Local\\Temp\\.{0,100}\\server\-3\.3\.5\.0\.msi/ nocase ascii wide
                        ...
                        $string29_RemoteUtilities_greyware_tool_keyword = /\\InternetIdService_.{0,100}\-.{0,100}\-.{0,100}\.txt/ nocase ascii wide
                        $string30_RemoteUtilities_greyware_tool_keyword = /\\Logs\\rut_log_.{0,100}\.html/ nocase ascii wide
