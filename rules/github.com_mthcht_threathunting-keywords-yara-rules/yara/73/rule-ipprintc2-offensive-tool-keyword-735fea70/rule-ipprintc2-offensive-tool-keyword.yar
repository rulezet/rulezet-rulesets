rule rule_IPPrintC2_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string15_IPPrintC2_offensive_tool_keyword = /\[System\.Text\.Encoding\]\:\:Unicode\.GetBytes\(\\"\[scriptblock\].{0,1000}\$x\=\{\$CommandDoc\}\;.{0,1000}\$x\.Invoke\(\)/ nocase ascii wide
                        ...
                        $string23_IPPrintC2_offensive_tool_keyword = /Add\-Printer\s\-Name\s\$PrinterName\s\-DriverName\s\\"Generic\s\/\sText\sOnly\\"\s.{0,1000}\s\-PortName/ nocase ascii wide
