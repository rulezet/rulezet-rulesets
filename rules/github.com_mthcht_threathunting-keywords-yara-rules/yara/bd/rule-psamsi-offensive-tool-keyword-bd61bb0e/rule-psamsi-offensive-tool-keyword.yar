rule rule_PSAmsi_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_PSAmsi_offensive_tool_keyword = /\s\-ScriptString\s.{0,1000}\s\-GetMinimallyObfuscated/ nocase ascii wide
                        $string4_PSAmsi_offensive_tool_keyword = /\s\-ScriptString\s.{0,1000}\s\-PSAmsiScanner\s/ nocase ascii wide
                        $string5_PSAmsi_offensive_tool_keyword = /\s\-ServerUri\s.{0,1000}\s\-FindAmsiSignatures/ nocase ascii wide
