rule rule_esentutl_greyware_tool_keyword
{
    ...
    strings:
                        $string1_esentutl_greyware_tool_keyword = /Esentutl.{0,100}\/p\s\/o\s.{0,100}\.dit/ nocase ascii wide
                        $string2_esentutl_greyware_tool_keyword = /esentutl\.exe\s\/y\s\/vss\s.{0,100}\:\\windows\\ntds\\ntds\.dit/ nocase ascii wide
