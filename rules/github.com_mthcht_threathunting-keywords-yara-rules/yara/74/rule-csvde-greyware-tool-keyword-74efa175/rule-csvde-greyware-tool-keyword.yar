rule rule_csvde_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string2_csvde_greyware_tool_keyword = /csvde\s\-r\s.{0,100}\s\-f\s/ nocase ascii wide
                        $string3_csvde_greyware_tool_keyword = /csvde\.exe\s\-f\s/ nocase ascii wide
                        $string4_csvde_greyware_tool_keyword = /csvde\.exe\s\-r\s.{0,100}\s\-f\s/ nocase ascii wide
