rule rule_interactsh_greyware_tool_keyword
{
    ...
    strings:
                        $string1_interactsh_greyware_tool_keyword = /\.exec.{0,100}\.interact\.sh/ nocase ascii wide
                        ...
                        $string7_interactsh_greyware_tool_keyword = /curl.{0,100}\.interact\.sh/ nocase ascii wide
                        $string8_interactsh_greyware_tool_keyword = /http\:\/\/.{0,100}\.interact\.sh/ nocase ascii wide
                        $string9_interactsh_greyware_tool_keyword = "interactsh -" nocase ascii wide
                        $string10_interactsh_greyware_tool_keyword = /interactsh.{0,100}\.exe/ nocase ascii wide
                        $string11_interactsh_greyware_tool_keyword = /interactsh.{0,100}oast\./ nocase ascii wide
                        ...
                        $string15_interactsh_greyware_tool_keyword = /wget.{0,100}\.interact\.sh/ nocase ascii wide
