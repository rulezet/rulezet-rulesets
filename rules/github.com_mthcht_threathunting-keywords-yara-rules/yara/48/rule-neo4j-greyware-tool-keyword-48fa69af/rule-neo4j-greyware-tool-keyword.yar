rule rule_Neo4j_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string2_Neo4j_greyware_tool_keyword = /MATCH\s\(c\:Computer\).{0,100}\(t\:Computer\).{0,100}\s.{0,100}\-\[\:AllowedToDelegate\].{0,100}\sreturn\sp/ nocase ascii wide
                        $string3_Neo4j_greyware_tool_keyword = /MATCH\sp\=\(u\:User\)\-\[\:SQLAdmin\].{0,100}\(c\:Computer\)\sreturn\sp/ nocase ascii wide
