rule rule_inceptor_offensive_tool_keyword
{
    ...
    strings:
                        $string1_inceptor_offensive_tool_keyword = /\sinceptor\..{0,1000}dotnet/ nocase ascii wide
                        ...
                        $string32_inceptor_offensive_tool_keyword = /BYPASS\-DINVOKE.{0,1000}\.dll/ nocase ascii wide
                        ...
                        $string44_inceptor_offensive_tool_keyword = /frida\-trace\s\-x\sntdll\.dll\s\-i\s.{0,1000}\s\-p\s/ nocase ascii wide
                        $string45_inceptor_offensive_tool_keyword = /inceptor.{0,1000}POWERSHELL/ nocase ascii wide
                        ...
                        $string70_inceptor_offensive_tool_keyword = /inceptor.{0,1000}dotnet/ nocase ascii wide
