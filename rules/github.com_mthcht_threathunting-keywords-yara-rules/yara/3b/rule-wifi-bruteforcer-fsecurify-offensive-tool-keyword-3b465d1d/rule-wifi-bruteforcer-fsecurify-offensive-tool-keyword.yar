rule rule_wifi_bruteforcer_fsecurify_offensive_tool_keyword
{
    meta:
    ...
    strings:
                        $string1_wifi_bruteforcer_fsecurify_offensive_tool_keyword = "wifi-bruteforcer" nocase ascii wide
