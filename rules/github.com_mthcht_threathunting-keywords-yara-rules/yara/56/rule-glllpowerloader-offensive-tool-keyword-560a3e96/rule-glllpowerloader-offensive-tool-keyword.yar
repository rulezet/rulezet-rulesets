rule rule_GlllPowerloader_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string9_GlllPowerloader_offensive_tool_keyword = /\[IO\.File\]\:\:ReadAllText\(.{0,1000}stubps1tovbs\.ps1/ nocase ascii wide
                        ...
                        $string26_GlllPowerloader_offensive_tool_keyword = /\-\-upload\-file.{0,1000}transfer\.sh/ nocase ascii wide
