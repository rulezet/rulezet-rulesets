rule rule_defender_control_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string66_defender_control_offensive_tool_keyword = /tCommand\s\=\s\\"windowsdefender\:\/\/Threatsettings\\".{0,1000}CreateObject\(\\"Shell\.Application\\"\)\.ShellExecute\(tCommand\)/ nocase ascii wide
