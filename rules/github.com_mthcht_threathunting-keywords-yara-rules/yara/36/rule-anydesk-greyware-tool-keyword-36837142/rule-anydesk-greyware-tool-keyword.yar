rule rule_anydesk_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string12_anydesk_greyware_tool_keyword = /\/home\/.{0,100}\/\.anydesk\//
                        ...
                        $string38_anydesk_greyware_tool_keyword = /\\ProgramFile.{0,100}\\previous\-version/ nocase ascii wide
                        ...
                        $string48_anydesk_greyware_tool_keyword = /Anydesk.{0,100}\s\-\-start\-with\-win\s\-\-silent/ nocase ascii wide
                        ...
                        $string55_anydesk_greyware_tool_keyword = /cmd\s\/c\s\'echo\sAa123456\!\s.{0,100}\s\-\-set\-password/ nocase ascii wide
                        ...
                        $string59_anydesk_greyware_tool_keyword = /programdata\\.{0,100}\s\-\-start\-with\-win\s\-\-remove\-first\s\-\-silent\s\-\-start\-service/ nocase ascii wide
                        $string60_anydesk_greyware_tool_keyword = /relay\-.{0,100}\.net\.anydesk\.com/ nocase ascii wide
