rule rule_fex_net_greyware_tool_keyword
{
    ...
    strings:
                        $string1_fex_net_greyware_tool_keyword = /https\:\/\/.{0,100}\.fex\.net\/download\// nocase ascii wide
                        $string2_fex_net_greyware_tool_keyword = /https\:\/\/.{0,100}\.fex\.net\/upload\// nocase ascii wide
