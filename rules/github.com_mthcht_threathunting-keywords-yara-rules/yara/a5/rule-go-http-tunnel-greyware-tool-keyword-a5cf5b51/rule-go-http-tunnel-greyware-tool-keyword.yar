rule rule_go_http_tunnel_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string2_go_http_tunnel_greyware_tool_keyword = /\/\.tunneld\/.{0,100}\.key/
                        ...
                        $string44_go_http_tunnel_greyware_tool_keyword = /tunnel\s\-config\s.{0,100}tunnel\.yml/ nocase ascii wide
                        $string45_go_http_tunnel_greyware_tool_keyword = "tunneld -tlsCrt " nocase ascii wide
