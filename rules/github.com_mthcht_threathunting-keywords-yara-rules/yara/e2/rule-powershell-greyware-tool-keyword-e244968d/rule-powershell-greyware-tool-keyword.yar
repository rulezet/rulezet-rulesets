rule rule_powershell_greyware_tool_keyword
{
    ...
    strings:
                        $string1_powershell_greyware_tool_keyword = /\s\/c\sstart\s\/min\spowershell\s\-noprofile\s\-w\sH\s\-c\s.{0,100}irw/ nocase ascii wide
                        $string2_powershell_greyware_tool_keyword = /\s\-ep\sBypass\s\-nop\sfunction\s.{0,100}\[System\.Security\.Cryptography\.Aes\]\:\:Create\(\).{0,100}\.CreateDecryptor\(\).{0,100}\.TransformFinalBlock.{0,100}\[System\.Text\.Encoding\]\:\:Utf8\.GetString/ nocase ascii wide
                        $string3_powershell_greyware_tool_keyword = /\s\-ep\sUnrestricted\s\-nop\sfunction\s.{0,100}\[System\.Security\.Cryptography\.Aes\]\:\:Create\(\).{0,100}\.CreateDecryptor\(\).{0,100}\.TransformFinalBlock.{0,100}\[System\.Text\.Encoding\]\:\:Utf8\.GetString/ nocase ascii wide
                        ...
                        $string8_powershell_greyware_tool_keyword = /\s\-W\sHidden\s\-command\s.{0,100}https\:\/\/.{0,100}Invoke\-WebRequest.{0,100}\;\siex\s\$/ nocase ascii wide
                        $string9_powershell_greyware_tool_keyword = /\s\-W\sHidden\s\-command\s.{0,100}Invoke\-WebRequest.{0,100}https\:\/\/.{0,100}\;\siex\s\$/ nocase ascii wide
                        ...
                        $string11_powershell_greyware_tool_keyword = /\\"\[IO\.File\]\:\:WriteAllBytes\(\$.{0,100}\,\[Convert\]\:\:FromBase64String\(\\"/ nocase ascii wide
                        ...
                        $string18_powershell_greyware_tool_keyword = /\\powershell\.exe.{0,100}\s\+\=\shidden/ nocase ascii wide
                        $string19_powershell_greyware_tool_keyword = /\\powershell\.exe.{0,100}\s\+\=hidden/ nocase ascii wide
                        $string20_powershell_greyware_tool_keyword = /\\powershell\.exe.{0,100}\s\=\shidden/ nocase ascii wide
                        $string21_powershell_greyware_tool_keyword = /\\powershell\.exe.{0,100}\s\=hidden/ nocase ascii wide
                        $string22_powershell_greyware_tool_keyword = /\\SOFTWARE\\Policies\\Microsoft\\VisualStudio\\Devtunnels.{0,100}\s\-Name\s\\"DisableDevTunnelsInVisualStudio\\"\s\-Value\s0\s\-Type\sDword/ nocase ascii wide
                        ...
                        $string25_powershell_greyware_tool_keyword = /Add\-DnsClientDohServerAddress\s.{0,100}\-ServerAddress\s/ nocase ascii wide
                        ...
                        $string28_powershell_greyware_tool_keyword = /Add\-MpPreference\s\-ExclusionProcess\s.{0,100}\\Windows\\System32\\WindowsPowerShell\\v1\.0\\powershell\.exe/ nocase ascii wide
                        $string29_powershell_greyware_tool_keyword = /Add\-PswaAuthorizationRule\s\-UsernName\s\\.{0,100}\s\-ComputerName\s\\.{0,100}\s\-ConfigurationName\s\\/ nocase ascii wide
                        $string30_powershell_greyware_tool_keyword = /Add\-PswaAuthorizationRule.{0,100}\-ComputerName\s/ nocase ascii wide
                        $string31_powershell_greyware_tool_keyword = /Add\-PswaAuthorizationRule.{0,100}\-UserName\s/ nocase ascii wide
                        $string32_powershell_greyware_tool_keyword = /Add\-PswaAuthorizationRule.{0,100}\-UserName\s/ nocase ascii wide
                        ...
                        $string40_powershell_greyware_tool_keyword = /copy\-item\s.{0,100}\\roaming\\microsoft\\windows\\start\smenu\\programs\\startup/ nocase ascii wide
                        ...
                        $string43_powershell_greyware_tool_keyword = /dism\.exe.{0,100}\/enable\-feature.{0,100}WindowsPowerShellWebAccess\s/ nocase ascii wide
                        ...
                        $string56_powershell_greyware_tool_keyword = /foreach\s\(\$.{0,100}\s\{Test\-NetConnection\s\-Port\s/ nocase ascii wide
                        ...
                        $string60_powershell_greyware_tool_keyword = /Get\-ADGroup\s\-Filter\s.{0,100}Name\s\-like\s.{0,100}admin/ nocase ascii wide
                        ...
                        $string63_powershell_greyware_tool_keyword = /Get\-ADObject\s\-Filter\s\{msDS\-AllowedToDelegateTo\s.{0,100}\s\-Properties\smsDS\-AllowedToDelegateTo/ nocase ascii wide
                        $string64_powershell_greyware_tool_keyword = /Get\-ADObject\s\-SearchBase\s.{0,100}CN\=Shadow\sPrincipal\sConfiguration.{0,100}CN\=Services.{0,100}\s\(Get\-ADRootDSE\)\.configurationNamingContext\)\s\|\sselect\s.{0,100}msDS\-ShadowPrincipalSid/ nocase ascii wide
                        ...
                        $string68_powershell_greyware_tool_keyword = /Get\-ChildItem\s\-Hidden\sC\:\\Users\\.{0,100}\\AppData\\Local\\Microsoft\\Credentials\\/ nocase ascii wide
                        $string69_powershell_greyware_tool_keyword = /Get\-ChildItem\s\-Hidden\sC\:\\Users\\.{0,100}\\AppData\\Roaming\\Microsoft\\Credentials\\/ nocase ascii wide
                        ...
                        $string78_powershell_greyware_tool_keyword = /Get\-NetGroupMember\s\-GroupName\s.{0,100}DNSAdmins/ nocase ascii wide
                        ...
                        $string81_powershell_greyware_tool_keyword = /HostVersion\=2\.0.{0,100}EngineVersion\=2\.0/ nocase ascii wide
                        ...
                        $string91_powershell_greyware_tool_keyword = /Invoke\-WebRequest\sifconfig\.me\/ip.{0,100}Content\.Trim\(\)/ nocase ascii wide
                        ...
                        $string94_powershell_greyware_tool_keyword = /New\-ItemProperty\s\-Path\s\\"HKLM\:\\Software\\Microsoft\\Windows\sNT\\CurrentVersion\\Winlogon\\SpecialAccounts\\Userlist\\"\s\-Name\s.{0,100}\s\-Value\s0\s\-PropertyType\sDword/ nocase ascii wide
                        ...
                        $string97_powershell_greyware_tool_keyword = /New\-NetFirewallRule\s.{0,100}\s\-Enabled\sTrue\s\-Direction\sInbound\s\-Protocol\sTCP\s\-Action\sAllow\s\-LocalPort\s22/ nocase ascii wide
                        $string98_powershell_greyware_tool_keyword = /New\-Object\sSystem\.Net\.Sockets\.TCPClient\(.{0,100}\$stream\s\=\s\$client\.GetStream\(\).{0,100}\[byte\[\]\]\$bytes\s\=\s0\.\.65535/ nocase ascii wide
                        ...
                        $string101_powershell_greyware_tool_keyword = /powershell\s\-c\s.{0,100}\\windows\\system32\\inetsrv\\appcmd\.exe\slist\sapppool\s\/\@t\:/ nocase ascii wide
                        $string102_powershell_greyware_tool_keyword = "powershell -c clear" nocase ascii wide
                        $string103_powershell_greyware_tool_keyword = /powershell\sNew\-ItemProperty\s\-Path\s.{0,100}HKLM\:\\SOFTWARE\\Policies\\Microsoft\\Windows\sDefender.{0,100}\s\-Name\sDisableAntiSpyware\s\-Value\s1\s\-PropertyType\sDWORD\s\-Force/ nocase ascii wide
                        ...
                        $string107_powershell_greyware_tool_keyword = /powershell.{0,100}Uninstall\-WindowsFeature\s\-Name\sWindows\-Defender\-GUI/ nocase ascii wide
                        $string108_powershell_greyware_tool_keyword = /Powershell\.exe\s\s\-windowstyle\shidden\s\-nop\s\-ExecutionPolicy\sBypass\s\s\-Commmand\s.{0,100}C\:\\Users\\.{0,100}\\AppData\\Roaming\\/ nocase ascii wide
                        ...
                        $string111_powershell_greyware_tool_keyword = /powershell\.exe\s\-exec\sbypass\s\-noni\s\-nop\s\-w\s1\s\-C.{0,100}invoke_obfuscation/ nocase ascii wide
                        ...
                        $string121_powershell_greyware_tool_keyword = /reg\sdelete\s.{0,100}\s\/v\sMRUList\s\/f/ nocase ascii wide
                        ...
                        $string124_powershell_greyware_tool_keyword = /Remove\-Item\s\-LiteralPath\s\\"C\:\\Program\sFiles\\Sophos.{0,100}\\"\s\-Force\s\-Recurse/ nocase ascii wide
                        ...
                        $string127_powershell_greyware_tool_keyword = /Remove\-ItemProperty\s\-Path.{0,100}\s\-Name\sMRUList\s/ nocase ascii wide
                        $string128_powershell_greyware_tool_keyword = /Remove\-ItemProperty.{0,100}HKLM\:\\SOFTWARE\\Policies\\Microsoft\\VisualStudio\\Devtunnels.{0,100}DisableDevTunnelsInVisualStudio/ nocase ascii wide
                        $string129_powershell_greyware_tool_keyword = /root\/SecurityCenter2.{0,100}\s\-ClassName\sAntiVirusProduct/ nocase ascii wide
                        $string130_powershell_greyware_tool_keyword = /S\`eT\-It\`em\s\(\s\'V\'\+\'aR\'\s\+\s\s\'IA\'\s\+\s\(\'blE\:1\'\+\'q2\'\)/ nocase ascii wide
                        $string131_powershell_greyware_tool_keyword = /Set\-ADObject\s\-SamAccountName\s.{0,100}\s\-PropertyName\sscriptpath\s\-PropertyValue\s.{0,100}\\.{0,100}\.exe/ nocase ascii wide
                        ...
                        $string134_powershell_greyware_tool_keyword = /Set\-ItemProperty.{0,100}HKLM\:\\SOFTWARE\\Policies\\Microsoft\\VisualStudio\\Devtunnels.{0,100}DisableDevTunnelsInVisualStudio.{0,100}0/ nocase ascii wide
                        ...
                        $string145_powershell_greyware_tool_keyword = /Stop\-Process\s\-Name\s\\"storagecraft\simagemanager.{0,100}\\"/ nocase ascii wide
