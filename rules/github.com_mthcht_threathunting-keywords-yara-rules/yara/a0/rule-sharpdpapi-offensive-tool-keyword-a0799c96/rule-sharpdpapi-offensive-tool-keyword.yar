rule rule_SharpDPAPI_offensive_tool_keyword
{
    ...
    strings:
                        $string1_SharpDPAPI_offensive_tool_keyword = /\sbackupkey.{0,1000}\s\/server\:.{0,1000}\s\/file.{0,1000}\.pvk/ nocase ascii wide
                        $string2_SharpDPAPI_offensive_tool_keyword = /\sblob\s\/target\:.{0,1000}\.bin.{0,1000}\s\/pvk\:/ nocase ascii wide
                        $string3_SharpDPAPI_offensive_tool_keyword = /\sblob\s\/target\:.{0,1000}\.bin.{0,1000}\s\/unprotect/ nocase ascii wide
                        ...
                        $string6_SharpDPAPI_offensive_tool_keyword = /\sps\s\/target\:.{0,1000}\.xml\s\/unprotect/ nocase ascii wide
                        $string7_SharpDPAPI_offensive_tool_keyword = /\svaults\s\/target\:.{0,1000}\s\/pvk\:/ nocase ascii wide
                        $string8_SharpDPAPI_offensive_tool_keyword = /\.exe\s\scertificates\s\/pvk\:.{0,1000}\.pvk/ nocase ascii wide
                        $string9_SharpDPAPI_offensive_tool_keyword = /\.exe\s\skeepass\s\/unprotect/ nocase ascii wide
                        $string10_SharpDPAPI_offensive_tool_keyword = /\.exe\sbackupkey\s\/nowrap\s.{0,1000}\.pvk/ nocase ascii wide
                        ...
                        $string13_SharpDPAPI_offensive_tool_keyword = /\.exe\scertificates\s\/mkfile\:.{0,1000}\.txt/ nocase ascii wide
                        $string14_SharpDPAPI_offensive_tool_keyword = /\.exe\scertificates\s\/unprotect/ nocase ascii wide
                        $string15_SharpDPAPI_offensive_tool_keyword = /\.exe\scredentials\s\/pvk\:.{0,1000}\.pvk/ nocase ascii wide
                        ...
                        $string22_SharpDPAPI_offensive_tool_keyword = /\.exe\sps\s\/target\:C\:\\Temp\\.{0,1000}\s\/unprotect/ nocase ascii wide
                        ...
                        $string42_SharpDPAPI_offensive_tool_keyword = /SharpChrome.{0,1000}\sbackupkey\s.{0,1000}\.pvk/ nocase ascii wide
                        ...
                        $string46_SharpDPAPI_offensive_tool_keyword = /SharpDPAPI.{0,1000}\scredentias\s/ nocase ascii wide
                        $string47_SharpDPAPI_offensive_tool_keyword = /SharpDPAPI.{0,1000}\svaults\s/ nocase ascii wide
