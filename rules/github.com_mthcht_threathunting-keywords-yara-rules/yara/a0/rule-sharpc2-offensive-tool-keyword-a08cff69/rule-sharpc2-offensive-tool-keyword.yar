rule rule_SharpC2_offensive_tool_keyword
{
    ...
    strings:
                        ...
                        $string61_SharpC2_offensive_tool_keyword = /http.{0,1000}127\.0\.0\.1\:50050/ nocase ascii wide
                        $string62_SharpC2_offensive_tool_keyword = /http.{0,1000}localhost\:50050/ nocase ascii wide
                        ...
                        $string80_SharpC2_offensive_tool_keyword = /SharpC2.{0,1000}\.cs/ nocase ascii wide
                        $string81_SharpC2_offensive_tool_keyword = /SharpC2.{0,1000}\.exe/ nocase ascii wide
                        $string82_SharpC2_offensive_tool_keyword = /sharpc2.{0,1000}client\-windows\.zip/ nocase ascii wide
                        ...
                        $string93_SharpC2_offensive_tool_keyword = /TeamServer\/Pivots\/.{0,1000}\./ nocase ascii wide
