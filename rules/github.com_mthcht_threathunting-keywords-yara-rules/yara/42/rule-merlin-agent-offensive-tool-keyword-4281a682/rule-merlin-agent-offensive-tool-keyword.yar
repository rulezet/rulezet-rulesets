rule rule_merlin_agent_offensive_tool_keyword
{
    ...
    strings:
                        $string1_merlin_agent_offensive_tool_keyword = /\slink\ssmb\s.{0,1000}\smerlinPipe/ nocase ascii wide
                        ...
                        $string5_merlin_agent_offensive_tool_keyword = /\/merlinAgent\-.{0,1000}\.exe/ nocase ascii wide
                        ...
                        $string15_merlin_agent_offensive_tool_keyword = /\\merlinAgent\-.{0,1000}\.exe/ nocase ascii wide
                        $string16_merlin_agent_offensive_tool_keyword = /\\merlin\-agent\\.{0,1000}\.go/ nocase ascii wide
                        ...
                        $string34_merlin_agent_offensive_tool_keyword = /docker\sbuild\s\-t\smerlin\-agent\:.{0,1000}\-linux/
                        ...
                        $string59_merlin_agent_offensive_tool_keyword = /rundll32\.exe.{0,1000}\smerlin\.dll\,Magic/ nocase ascii wide
                        $string60_merlin_agent_offensive_tool_keyword = /rundll32\.exe.{0,1000}\smerlin\.dll\,Merlin/ nocase ascii wide
                        $string61_merlin_agent_offensive_tool_keyword = /rundll32\.exe.{0,1000}\smerlin\.dll\,Run/ nocase ascii wide
