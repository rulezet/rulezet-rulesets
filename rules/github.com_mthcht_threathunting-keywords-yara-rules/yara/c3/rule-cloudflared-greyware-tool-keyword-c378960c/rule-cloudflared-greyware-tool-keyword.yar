rule rule_cloudflared_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string5_cloudflared_greyware_tool_keyword = /\/cloudflared\-linux\-.{0,100}\.deb/
                        $string6_cloudflared_greyware_tool_keyword = /\/cloudflared\-linux\-.{0,100}\.rpm/
                        ...
                        $string48_cloudflared_greyware_tool_keyword = /echo\s\'alias\scat\=\/bin\/bash\s\-c\s\'bash\s\-i\s\>\&\s\/dev\/tcp\/.{0,100}\/.{0,100}\s0\>\&1\'\'\s\>\>\s.{0,100}\/\.bashrc.{0,100}\s/
                        $string49_cloudflared_greyware_tool_keyword = /echo\s\'alias\sfind\=\/bin\/bash\s\-c\s\'bash\s\-i\s\>\&\s\/dev\/tcp\/.{0,100}\/.{0,100}\>\>\s\\"\$user\/\.bashrc\\"/
