rule rule_wireproxy_greyware_tool_keyword
{
    ...
    strings:
                        $string1_wireproxy_greyware_tool_keyword = /\swireproxy\.service/
                        $string2_wireproxy_greyware_tool_keyword = "/bin/wireproxy"
                        $string3_wireproxy_greyware_tool_keyword = /\/wireproxy\.conf/
                        $string4_wireproxy_greyware_tool_keyword = /\/wireproxy\.git/ nocase ascii wide
                        $string5_wireproxy_greyware_tool_keyword = /\/wireproxy\.service/
                        $string6_wireproxy_greyware_tool_keyword = "/wireproxy/releases/" nocase ascii wide
                        $string7_wireproxy_greyware_tool_keyword = "/wireproxy_darwin"
                        $string8_wireproxy_greyware_tool_keyword = "/wireproxy_linux_"
                        $string9_wireproxy_greyware_tool_keyword = "/wireproxy_windows" nocase ascii wide
                        $string10_wireproxy_greyware_tool_keyword = "/wireproxy-ci-test"
                        $string11_wireproxy_greyware_tool_keyword = "/wireproxy-master"
                        $string12_wireproxy_greyware_tool_keyword = "/wireproxy-udp"
                        ...
                        $string128_wireproxy_greyware_tool_keyword = "wireproxy --"
                        $string129_wireproxy_greyware_tool_keyword = "wireproxy -c "
                        $string130_wireproxy_greyware_tool_keyword = "wireproxy -n "
                        $string131_wireproxy_greyware_tool_keyword = "wireproxy -s"
