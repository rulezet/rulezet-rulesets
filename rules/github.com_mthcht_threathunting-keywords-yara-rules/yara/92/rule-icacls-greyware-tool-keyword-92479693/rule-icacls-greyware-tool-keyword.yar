rule rule_icacls_greyware_tool_keyword
{
    ...
    strings:
                        ...
                        $string3_icacls_greyware_tool_keyword = /icacls\s\\"\%programdata\%\\Microsoft\\Windows\\Start\sMenu\\Programs\\Startup\\.{0,100}\\"\s2\>nul/ nocase ascii wide
                        ...
                        $string5_icacls_greyware_tool_keyword = /icacls\s\\"C\:\\Documents\sand\sSettings\\\%username\%\\Start\sMenu\\Programs\\Startup\\.{0,100}\\"\s2\>nul/ nocase ascii wide
                        ...
                        $string7_icacls_greyware_tool_keyword = /icacls\s\\"C\:\\Documents\sand\sSettings\\All\sUsers\\Start\sMenu\\Programs\\Startup\\.{0,100}\\"\s2\>nul/ nocase ascii wide
