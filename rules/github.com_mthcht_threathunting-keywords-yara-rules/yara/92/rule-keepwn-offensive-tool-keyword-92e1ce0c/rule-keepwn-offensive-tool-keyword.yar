rule rule_KeePwn_offensive_tool_keyword
{
    ...
    strings:
                        $string1_KeePwn_offensive_tool_keyword = /\s\-\-bruteforce\s.{0,1000}\.kdbx/ nocase ascii wide
                        ...
                        $string32_KeePwn_offensive_tool_keyword = /KeePwn\sv.{0,1000}\s\-\sby\sJulien\sBEDEL/ nocase ascii wide
