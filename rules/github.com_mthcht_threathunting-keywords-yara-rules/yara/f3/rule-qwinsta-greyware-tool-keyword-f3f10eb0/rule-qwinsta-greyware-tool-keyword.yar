rule rule_qwinsta_greyware_tool_keyword
{
    ...
    strings:
                        $string1_qwinsta_greyware_tool_keyword = /cmd\s\/c\s.{0,100}qwinsta/ nocase ascii wide
                        $string2_qwinsta_greyware_tool_keyword = /cmd\.exe.{0,100}qwinsta/ nocase ascii wide
