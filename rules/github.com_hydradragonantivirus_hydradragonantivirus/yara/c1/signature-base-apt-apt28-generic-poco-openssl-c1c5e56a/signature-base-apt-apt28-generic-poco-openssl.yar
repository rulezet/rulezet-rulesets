rule SIGNATURE_BASE_APT_APT28_Generic_Poco_Openssl {
  meta:
    ...
    source_url  = "https://github.com/Neo23x0/signature-base/blob/6b8e2a00e5aafcfcfc767f3f53ae986cf81f968a/yara/apt_apt28_drovorub.yar#L1-L21"
  ...
  strings:
    $mw1 = {
      89 F1 48 89 FE 48 89 D7 48 F7 C6 FF FF FF FF 0F 84 6B 02 00 00 48 F7 C7
    ...
    $mw4 = {
      53 8A 47 08 3C 06 74 21 84 C0 74 1D 3C 07 74 20 B9 ?? ?? ?? ?? BA FD 03
