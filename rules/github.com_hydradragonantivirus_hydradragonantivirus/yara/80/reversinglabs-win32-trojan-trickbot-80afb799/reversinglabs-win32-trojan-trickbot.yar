rule REVERSINGLABS_Win32_Trojan_Trickbot: TC_DETECTION MALICIOUS MALWARE FILE {
  meta:
    ...
    source_url          = "https://github.com/reversinglabs/reversinglabs-yara-rules//blob/d35a6845dcd00f2840f690611612b04dda6d195d/yara/trojan/Win32.Trojan.TrickBot.yara#L1-L46"
