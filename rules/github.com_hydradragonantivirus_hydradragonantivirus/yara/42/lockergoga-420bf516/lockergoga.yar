rule lockergoga {
  ...
  strings:
    ...
    $cert_2    = { 2E 7C 87 CC 0E 93 4A 52 FE 94 FD 1C B7 CD 34 AF }      $cert_3    = { 3D 25 80 E8 95 26 F7 85 2B 57 06 54 EF D9 A8 BF }      $cert_4    = { 4C AA F9 CA DB 63 6F E0 1F F7 4E D8 5B 03 86 9D }  
  condition:
    4 of them
}