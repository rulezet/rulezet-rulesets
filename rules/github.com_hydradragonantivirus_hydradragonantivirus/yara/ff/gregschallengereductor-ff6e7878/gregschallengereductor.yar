rule GregsChallengeReductor
{
    ...
    strings:
        $const_1 = { 24 95 73 C2 48 }         $const_2 = { FF FF FF 7F }            $pdb_start = "C:\\git_kraken_repo\\reductor-dev" 
        $mtx1 = "Global\\$$wrk_ls"
        $mtx2 = "Global\\$$wrk_ff"
        $mtx3 = "Global\\$$wrk_cr"
    condition:
        for all i in ( 1..#const_1 ) : ( $const_2 in ( @const_1[i]..@const_1[i]+10) )         or all of ($mtx*) 
        or $pdb_start
}