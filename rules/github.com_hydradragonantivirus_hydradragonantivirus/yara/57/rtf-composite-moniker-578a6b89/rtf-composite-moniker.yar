rule RTF_Composite_Moniker {
  ...
  strings:
    $magic_rtf = "{\\rt" nocase
    $st1       = "0903000000000000C000000000000046" nocase      $st2       = "0303000000000000C000000000000046" nocase      $st3       = "C6AFABEC197FD211978E0000F8757E2A" nocase      $st4       = "01004F006C0065" nocase  
  condition:
