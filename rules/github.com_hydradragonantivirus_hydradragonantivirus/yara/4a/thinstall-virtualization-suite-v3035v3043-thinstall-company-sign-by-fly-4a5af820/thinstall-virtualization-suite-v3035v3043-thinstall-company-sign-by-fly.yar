import "pe"
rule _Thinstall_Virtualization_Suite_V3035V3043__Thinstall_Company__Sign_by_fly_
{
	meta:
		description = "Thinstall Virtualization Suite V3.035-V3.043 -> Thinstall Company ! Sign by fly"
	strings:
