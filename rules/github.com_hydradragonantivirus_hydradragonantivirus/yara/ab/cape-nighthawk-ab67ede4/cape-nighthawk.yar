...
rule CAPE_Nighthawk {
  meta:
    ...
    source_url  = "https://github.com/kevoreilly/CAPEv2/blob/28da61aec456106a39ce5a81c1257f7cce7fb270/data/yara/CAPE/Nighthawk.yar#L3-L24"
  ...
  condition:
    uint16(0) == 0x5A4D and for any s in pe.sections: (s.name == ".profile") and all of them
}