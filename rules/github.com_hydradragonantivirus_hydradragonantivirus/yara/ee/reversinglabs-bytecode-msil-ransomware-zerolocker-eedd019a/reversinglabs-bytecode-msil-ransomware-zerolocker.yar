rule REVERSINGLABS_Bytecode_MSIL_Ransomware_Zerolocker: TC_DETECTION MALICIOUS MALWARE FILE {
  meta:
    ...
    source_url          = "https://github.com/reversinglabs/reversinglabs-yara-rules//blob/d35a6845dcd00f2840f690611612b04dda6d195d/yara/ransomware/ByteCode.MSIL.Ransomware.ZeroLocker.yara#L1-L70"
