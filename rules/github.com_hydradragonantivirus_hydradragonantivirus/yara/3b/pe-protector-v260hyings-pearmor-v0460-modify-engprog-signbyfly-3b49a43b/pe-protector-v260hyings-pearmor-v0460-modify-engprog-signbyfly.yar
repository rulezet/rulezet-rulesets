import "pe"
rule _PE_Protector_V260hyings_PEArmor_V0460_modify__Engprog__SignByfly_
{
	meta:
		description = "PE_Protector V2.60��hying's PE-Armor V0.460 modify�� -> Engprog * Sign.By.fly"
	strings:
