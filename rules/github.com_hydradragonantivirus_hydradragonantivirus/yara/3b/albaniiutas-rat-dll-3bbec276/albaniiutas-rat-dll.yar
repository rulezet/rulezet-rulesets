rule albaniiutas_rat_dll {
  meta:
    ...
    sample      = "fd43fa2e70bcc3b602363667560494229287bf4716638477889ae3f816efc705"      severity    = 9
    date        = "2021-07-06"

  strings:
    $rc4_key         = { 00 4C 21 51 40 57 23 45 24 52 25 54 5E 59 26 55 2A 41 7C 7D 74 7E 6B 00 }      $aes256_str_seed = { 00 30 33 30 34 32 37 36 63 66 34 66 33 31 33 34 35 00 }      $s0              = "http://%s/%s/%s/" fullword ascii
