import "pe"
rule _Upack_028__0399_relocated_image_base__Delphi_NET_DLL_or_something_else__Dwing_
{
	meta:
		description = "Upack 0.28 - 0.399 (relocated image base - Delphi, .NET, DLL or something else -> Dwing"
	strings:
