rule STEALER_credstealesy_ren
{
	...
	strings:
		...
		$my_hex_string = "CurrentControlSet\\Control\\Keyboard Layouts\\" wide 		$my_hex_string2 = {89 45 E8 3B 7D E8 7C 0F 8B 45 E8 05 FF 00 00 00 2B C7 89 45 E8} 
	condition:
