rule ARKBIRD_SOLG_WIP_Meteorexpress_Aug_2021_1: FILE {
  ...
  strings:
    ...
    $s6 = "icacls.exe \"C:\\ProgramData\\Microsoft\\Windows\\SystemData\\S-1-5-18\\ReadOnly\" /reset /T"
    $s7 = "wmic computersystem where name=\"%computername%\" call unjoindomainorworkgroup"
