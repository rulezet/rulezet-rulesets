rule infostealer_win_phoenixwave {
  ...
  strings:
    ...
    $str3 = "aHR0cDovL2lwLWFwaS5jb20vanNvbg==" wide      $str4 = "TG9jYWxBcHBEYXRh" wide      $str5 = "UGhvZW5peFdhdmU=" wide      $str6 = "virustotal" wide
    ...
    $app3 = "\\D877F783D5D3EF8C\\" wide      $app4 = "\\IndexedDB\\file__0.indexeddb.leveldb" wide
