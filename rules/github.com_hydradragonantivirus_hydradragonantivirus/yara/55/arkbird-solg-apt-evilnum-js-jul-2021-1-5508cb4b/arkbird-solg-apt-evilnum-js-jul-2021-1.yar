rule ARKBIRD_SOLG_APT_Evilnum_JS_Jul_2021_1: FILE {
  ...
  strings:
    $s1 = "WScript.CreateObject(\"MSXml2.DOMDocument\").createElement(\"Base64Data\");"
    $s2 = "WScript.CreateObject(\"MSXml2.DOMDocument\").createElement(\"Base64Data\");"
    ...
    $s6 = "WScript.CreateObject(\"ADODB.Stream\");"
