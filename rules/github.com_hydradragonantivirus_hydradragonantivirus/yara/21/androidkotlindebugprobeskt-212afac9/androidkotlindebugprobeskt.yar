rule AndroidKotlinDebugProbesKt {
  ...
  condition:
    ...
    and uint16be(6) & 0xff >= 43      and 3 < uint16be(8) and uint16be(8) <= 3000      and uint16be(11) == 44      and for all i in (1..uint16be(11)): (        0x20 <= (uint16be(11 + i) & 0xff) and (uint16be(11 + i) & 0xff) < 127
    )
    and $constant at 13
}