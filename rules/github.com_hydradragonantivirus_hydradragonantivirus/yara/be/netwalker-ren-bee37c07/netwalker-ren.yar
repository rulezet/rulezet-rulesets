rule Netwalker_ren: ransomware {
  meta:
    description = "Detects Netwalker Ransomware"
    author      = "Marius 'f0wL' Genheimer <hello@dissectingmalwa.re>"
    reference   = "https://github.com/f0wl/configwalker"
    date        = "2020-10-26"      hash1       = "4f7bdda79e389d6660fca8e2a90a175307a7f615fa7673b10ee820d9300b5c60"
  ...
  condition:
    uint16(0) == 0x5a4d
    and filesize > 45KB      and filesize < 130KB      and 6 of ($conf*)
    and 3 of ($s*)
}