rule _Trojan_Autorun_Trojan_GenericKD_72869045_Virus_Hijack_Gen_Troja_315 {
  meta:
    ...
    hash12      = "9b1f053694c3db989f5c342cf8e2239bee4a1942950b85043637104969e007fe"
  ...
  strings:
    $s1 = "No Execute" fullword wide
    $s2 = "Mutant (Mutex) Info" fullword wide
    $s3 = "Write Combine" fullword wide
    $s4 = "thumb initial drag" fullword wide
    $s5 = "Hold Count:" fullword wide
    $s6 = "Athumb while drag" fullword wide
    $s7 = "Protected Image" fullword wide
    $s8 = "Large Pages" fullword wide
