rule win_l0rdix {
  ...
  strings:
    $ua           = "Mozilla/5.0 (Windows NT 10.0; WOW64; rv:53.0) Gecko/20100101 Firefox/53.0" wide      $sig          = "L0rdix" wide ascii
    ...
    $coin_regex_1 = "[13][a-km-zA-HJ-NP-Z1-9]{25,34}" wide      $coin_regex_2 = "0x[a-fA-F0-9]{40}" wide      $coin_regex_3 = "L[a-zA-Z0-9]{26,33}" wide  
  condition:
