rule _Trojan_Autorun_Trojan_GenericKD_72869045_Virus_Hijack_Gen_Troja_441 {
  meta:
  ...
  strings:
    $s1 = "Symbolic Link Target" fullword wide
    $s2 = "Interval: %d sec" fullword wide
    $s3 = "%s, offset: 0x%08X" fullword wide
    $s4 = "BCannot open this object type" fullword wide
    $s5 = "This object type cannot be opened" fullword wide
