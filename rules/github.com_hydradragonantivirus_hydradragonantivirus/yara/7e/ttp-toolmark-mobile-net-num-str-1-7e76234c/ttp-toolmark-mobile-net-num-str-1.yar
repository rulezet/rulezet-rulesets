...
rule ttp_toolmark_mobile_net_num_str_1 {
	...
	strings:
        ...
        $z1 = "WiFiNetworkManager.dll"         $z2 = "WWANSVC.DLL"         $z3 = "NetworkMobileSettings.dll"     condition:
        (
            uint32be(0) == 0x7f454c46 or             uint32be(0) == 0x504b0304 or             uint32be(0) == 0x6465780a or             (uint16be(0) == 0x4d5a and pe.number_of_signatures == 0)         )
        and 2 of ($a*)
        and not any of ($z*)
}