rule SUSP_PE_Signed_by_Suspicious_Entitiy_Mar23
{
    ...
    strings:
                $cert1 = "91210242MA0YGH36" wide ascii         $cert2 = "Copyright (C) 2013-2021 QuickZip. All rights reserved." wide ascii 
        $cert3 = "Qi Lijun" wide ascii         $cert4 = {51 00 69 00 20 00 4c 00 69 00 6a 00 75 00 6e}         $cert5 = "Luck Bigger Technology Co., Ltd" wide ascii
        $cert6 = {4c 00 75 00 63 00 6b 00 20 00 42 00 69 00 67 00 67 00 65 00 72 00 20 00 54 00 65 00 63 00 68 00 6e 00 6f 00 6c 00 6f 00 67 00 79 00 20 00 43 00 6f 00 2e 00 2c 00 20 00 4c 00 74 00 64 }         $cert7 = "XinSing Network Service Co., Ltd" wide ascii
