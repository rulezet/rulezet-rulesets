rule MAL_UNC2891_Slapstick {
   ...
   strings:
      $code1 = {F6 50 04 48 FF C0 48 39 D0 75 F5}       $code2 = {88 01 48 FF C1 8A 11 89 C8 29 F8 84 D2 0F 85}       $str1 = "/proc/self/exe" fullword ascii
      $str2 = "%-23s %-23s %-23s %-23s %-23s %s" fullword ascii
      $str3 = "pam_sm_authenticate" ascii
      
      $str_fr1 = "HISTFILE=/dev/null"    condition:
