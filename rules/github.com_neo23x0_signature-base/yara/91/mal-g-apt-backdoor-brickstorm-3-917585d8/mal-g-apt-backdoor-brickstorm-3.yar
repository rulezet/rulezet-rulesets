rule MAL_G_APT_Backdoor_BRICKSTORM_3 {
   ...
   strings:
      ...
      $str4 = "decompress" ascii        $str5 = "MIMEHeader" ascii        $str6 = "ResolveReference" ascii        $str7 = "115792089210356248762697446949407573529996955224135760342422259061068512044369115792089210356248762697446949407573530086143415290314195533631308867097853951" ascii     condition:
