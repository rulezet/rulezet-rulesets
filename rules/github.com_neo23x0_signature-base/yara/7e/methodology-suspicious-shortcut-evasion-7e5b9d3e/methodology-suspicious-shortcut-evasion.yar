rule Methodology_Suspicious_Shortcut_Evasion
{
  ...
  condition:
    any of ($filetype*) and $URI     and uint16(0) != 0x5A4D and uint32(0) != 0x464c457f and uint32(0) != 0xBEBAFECA and uint32(0) != 0xFEEDFACE and uint32(0) != 0xFEEDFACF and uint32(0) != 0xCEFAEDFE
    and filesize < 30KB
}