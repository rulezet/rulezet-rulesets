rule webshell_php_by_string_obfuscation : FILE {
	...
	strings:
		...
		$opbs53 = "e'. 128/2 .'_' .'d"
        		$opbs54 = "<?php                                                                                                                                                                                " 		$opbs55 = "=chr(99).chr(104).chr(114);$_"
		$opbs56 = "\\x47LOBAL"
		$opbs57 = "pay\".\"load"
		$opbs58 = "bas'.'e64"
		$opbs59 = "dec'.'ode"
	...
	condition:
		...
		and any of ( $opbs* )
		and not 1 of ($fp*)
      and not filepath contains "\\Cache\\" 
      and not filepath contains "\\User Data\\Default\\Extensions\\"       and not filepath contains "\\cache2\\"       and not filepath contains "\\Microsoft\\Windows\\INetCache\\IE\\"       and not filepath contains "/com.apple.Safari/WebKitCache/"
      and not filepath contains "\\Edge\\User Data\\" }