rule SUSP_LNK_lnkfileoverRFC {
   ...
   strings:
      $command = "C:\\Windows\\System32\\cmd.exe" fullword ascii       $command2 =  {2F 00 63 00 20 00 66 00 69 00 6E 00 64 00 73 00 74 00 72}       $base64 = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD" ascii       $cert = " -decode " ascii    condition:
