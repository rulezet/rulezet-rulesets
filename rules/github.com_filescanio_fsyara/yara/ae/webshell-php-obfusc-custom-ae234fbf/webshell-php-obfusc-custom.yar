rule WEBSHELL_PHP_OBFUSC_CUSTOM : hardened limited
{
	meta:
	...
	strings:
		...
		$obf2 = {2e 24 47 4c 4f 42 41 4c 53}
	...
	condition:
		not ( any of ( $gfp* ) ) and ( ( ( $php_short in ( 0 .. 100 ) or $php_short in ( filesize - 1000 .. filesize ) ) and not any of ( $no_* ) ) or any of ( $php_new* ) ) and ( ( #obf1 > 2 ) or ( #obf2 > 200 ) )
}