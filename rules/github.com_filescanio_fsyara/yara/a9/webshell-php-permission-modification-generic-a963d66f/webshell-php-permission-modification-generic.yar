rule WEBSHELL_PHP_Permission_Modification_Generic : hardened limited
{
	meta:
	...
	strings:
		$perm1 = {((63 68 6d 6f 64 28 24 5f) | (63 00 68 00 6d 00 6f 00 64 00 28 00 24 00 5f 00))}
		$perm2 = {((63 68 6f 77 6e 28 24 5f) | (63 00 68 00 6f 00 77 00 6e 00 28 00 24 00 5f 00))}
		$perm3 = {((63 68 67 72 70 28 24 5f) | (63 00 68 00 67 00 72 00 70 00 28 00 24 00 5f 00))}
		$perm4 = {((75 6d 61 73 6b 28 24 5f) | (75 00 6d 00 61 00 73 00 6b 00 28 00 24 00 5f 00))}
		$perm5 = {((66 69 6c 65 70 65 72 6d 73 28 24 5f) | (66 00 69 00 6c 00 65 00 70 00 65 00 72 00 6d 00 73 00 28 00 24 00 5f 00))}
		$action1 = {((75 6e 6c 69 6e 6b 28 24 5f) | (75 00 6e 00 6c 00 69 00 6e 00 6b 00 28 00 24 00 5f 00))}
		$action2 = {((73 79 6d 6c 69 6e 6b 28 24 5f) | (73 00 79 00 6d 00 6c 00 69 00 6e 00 6b 00 28 00 24 00 5f 00))}
		$action3 = {((6c 69 6e 6b 28 24 5f) | (6c 00 69 00 6e 00 6b 00 28 00 24 00 5f 00))}
		$action4 = {((72 65 61 64 6c 69 6e 6b 28 24 5f) | (72 00 65 00 61 00 64 00 6c 00 69 00 6e 00 6b 00 28 00 24 00 5f 00))}
	...
	condition:
		not ( any of ( $gfp* ) ) and ( ( ( $php_short in ( 0 .. 100 ) or $php_short in ( filesize - 1000 .. filesize ) ) and not any of ( $no_* ) ) or any of ( $php_new* ) ) and ( any of ( $inp* ) ) and ( any of ( $cpayload* ) or all of ( $m_cpayload_preg_filter* ) ) and ( ( any of ( $perm* ) ) and ( any of ( $action* ) ) )
}