...
rule Dll_Backdoor_FalseFront_Jan2024 {
    ...
    condition:
    pe.pdb_path == "D:\\a\\_work\\1\\s\\artifacts\\obj\\coreclr\\windows.x64.Release\\Corehost.Static\\singlefilehost.pdb"     and pe.imphash() == "68031a2b11c02bee00a0a687110994be"     and pe.dll_name == "singlefilehost.exe"
