...
rule DLL_DiceLoader_Fin7_Feb2024 {
    ...
    strings:
       $exp_func = /[a-zA-z]{16}\x00/        $s1 = "GetQueuedCompletionStatus"
    ...
    condition:
        pe.imphash() == "37af5cd8fc35f39f0815827f7b80b304"         or 
        (pe.number_of_exports == 1
        and pe.export_details[0].ordinal == 1  
        and ($exp_func at (0x2888) or $exp_func at (0x2338)))         and 5 of ($s*) and 4 of ($net*) and $other
