...
rule EXE_ICS_Indusroyer2_April2024 {
    ...
    strings:
                $config1 = {00 [2-5] 00 2e 00 [2-5] 00 2e 00 [2-5] 00 2e [2-5] 00                     20 00 32 00 34 00 30 00 34 00 20 00                                       ?? 00 20 00                                                              (30 | 31) 00 20 00                                                      31 00 20 00                                                            31 00 20 00}                                                                        
                $config2 = {2e 00 65 00 78 00 65                                               00 20 00 31 00 20 00                                               22 00 (43 | 44 | 45 | 46) 00 3a 00 5c 00                          }

                $config3 = {22 00 20 00 [1-2] 00                                           20 00 [1-2] 00 20 00                                          30 00 20 00                                                  30 00 20 00                                                 31 00 20 00                                                (30 | 31) 00 20 00                                        (30 | 31) 00 20 00                                       (38 | 31 00 36 |34 00 34) 00 20 00}         
        $cmd1 = "Length:%u bytes" 
        $cmd2 = "Sent=x%X"
        $cmd3 = "Received=x%X"
        $cmd4 = "ASDU:%u"
