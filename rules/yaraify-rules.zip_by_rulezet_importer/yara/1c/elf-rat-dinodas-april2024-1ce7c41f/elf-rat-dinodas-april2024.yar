rule ELF_RAT_Dinodas_April2024 {
    ...
    strings: 
        $key1 = {A1 A1 18 AA 10 F0 FA 16 06 71 B3 08 AA AF 31 A1}         $key2 = {A0 21 A1 FA 18 E0 C1 30 1F 9F C0 A1 A0 A6 6F B1} 
        $c2 = "update.centos-yum.com:443" fullword     
    ...
    condition:
        uint32be(0) == 0x7F454C46          and any of ($key*)
