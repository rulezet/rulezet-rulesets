...
rule EXE_Stealer_RisePro_Jan2024 {
    ...
    strings: 
        ...
        $s11 = "'false' /" 
    condition:
       pe.rich_signature.key== 3099257863         and pe.RESOURCE_TYPE_ICON == 3
       and for 5 resource in pe.resources: 
       (resource.language == 1049)        and  pe.resources[pe.number_of_resources-1].type == 24        and all of them in (filesize-700000..filesize)  }