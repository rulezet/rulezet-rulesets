rule LummaInjector {
    ...
    strings:
        $RegAsmPath = "QzpcXFdpbmRvd3NcXE1pY3Jvc29mdC5ORVRcXEZyYW1ld29ya1xcdjQuMC4zMDMxOVxcUmVnQXNtLmV4ZQ" wide ascii         
        $CreateProcess = "CreateProcess" ascii         $VirtualAllocEx = "VirtualAllocEx" ascii         $WriteProcess = "WriteProcessMemory" ascii         
    condition:
        all of them and
        uint16(0) == 0x5a4d
}